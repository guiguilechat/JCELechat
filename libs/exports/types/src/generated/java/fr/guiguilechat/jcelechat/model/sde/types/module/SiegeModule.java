...
import fr.guiguilechat.jcelechat.model.sde.attributes.BastionModeArmorRepairCapDurationBonus;
import fr.guiguilechat.jcelechat.model.sde.attributes.BastionModeShieldBoosterCapDurationBonus;
    ...
    extends Module
{
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int bastionmodearmorrepaircapdurationbonus;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int bastionmodeshieldboostercapdurationbonus;
    /**
