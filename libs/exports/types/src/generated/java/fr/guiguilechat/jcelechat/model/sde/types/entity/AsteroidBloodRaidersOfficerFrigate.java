...
public class AsteroidBloodRaidersOfficerFrigate
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<AsteroidBloodRaidersOfficerFrigate> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<AsteroidBloodRaidersOfficerFrigate>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/AsteroidBloodRaidersOfficerFrigate.yaml";
        private Map<Integer, AsteroidBloodRaidersOfficerFrigate> cache = (null);

        @Override
        public IMetaCategory<? super AsteroidBloodRaidersOfficerFrigate> category() {
        ...
        public String getName() {
            return "AsteroidBloodRaidersOfficerFrigate";
        }

        @Override
        public synchronized Map<Integer, AsteroidBloodRaidersOfficerFrigate> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AsteroidBloodRaidersOfficerFrigate.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AsteroidBloodRaidersOfficerFrigate> types;
        }
    }
}
