    ...
    extends Asteroid
{
    ...
    public static final Eifyrium.MetaGroup METAGROUP = new Eifyrium.MetaGroup();
    ...
    @Override
    public IMetaGroup<Eifyrium> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<Eifyrium>
    {
        public static final String RESOURCE_PATH = "SDE/types/asteroid/Eifyrium.yaml";
        private Map<Integer, Eifyrium> cache = (null);

        @Override
        public IMetaCategory<? super Eifyrium> category() {
        ...
        @Override
        public synchronized Map<Integer, Eifyrium> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(Eifyrium.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, Eifyrium> types;
        }
    }
}
