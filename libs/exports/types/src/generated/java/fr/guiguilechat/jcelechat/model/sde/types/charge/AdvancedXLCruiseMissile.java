...
public class AdvancedXLCruiseMissile
    extends Charge
{
    /**
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {AimedLaunch.INSTANCE, MaxVelocity.INSTANCE, Agility.INSTANCE, TechLevel.INSTANCE, Hp.INSTANCE, LauncherGroup.INSTANCE, AoeDamageReductionFactor.INSTANCE, DetonationRange.INSTANCE, StructureUniformity.INSTANCE, AoeVelocity.INSTANCE, AoeCloudSize.INSTANCE, AoeFalloff.INSTANCE, EmDamage.INSTANCE, ExplosiveDamage.INSTANCE, KineticDamage.INSTANCE, RequiredSkill1Level.INSTANCE, ThermalDamage.INSTANCE, RequiredSkill1 .INSTANCE, RequiredSkill2Level.INSTANCE, RequiredSkill2 .INSTANCE, RequiredSkill3Level.INSTANCE, RequiredSkill3 .INSTANCE, ExplosionDelay.INSTANCE, MetaLevelOld.INSTANCE })));
    ...
    @Override
    public IMetaGroup<AdvancedXLCruiseMissile> getGroup() {
        return METAGROUP;
    }
    ...
    {
        public static final String RESOURCE_PATH = "SDE/types/charge/AdvancedXLCruiseMissile.yaml";
        private Map<Integer, AdvancedXLCruiseMissile> cache = (null);

        @Override
        public IMetaCategory<? super AdvancedXLCruiseMissile> category() {
        ...
        public String getName() {
            return "AdvancedXLCruiseMissile";
        }

        @Override
        public synchronized Map<Integer, AdvancedXLCruiseMissile> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AdvancedXLCruiseMissile.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AdvancedXLCruiseMissile> types;
        }
    }
}
