...
public class WarpathInvadersCruisers
    extends Entity
{
    /**
    ...
    public static final WarpathInvadersCruisers.MetaGroup METAGROUP = new WarpathInvadersCruisers.MetaGroup();
    ...
    @Override
    public IMetaGroup<WarpathInvadersCruisers> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<WarpathInvadersCruisers>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/WarpathInvadersCruisers.yaml";
        private Map<Integer, WarpathInvadersCruisers> cache = (null);

        @Override
        public IMetaCategory<? super WarpathInvadersCruisers> category() {
        ...
        public String getName() {
            return "WarpathInvadersCruisers";
        }

        @Override
        public synchronized Map<Integer, WarpathInvadersCruisers> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(WarpathInvadersCruisers.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, WarpathInvadersCruisers> types;
        }
    }
}
