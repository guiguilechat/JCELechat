...
public class WarpathEliteMercenariesFrigates
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<WarpathEliteMercenariesFrigates> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<WarpathEliteMercenariesFrigates>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/WarpathEliteMercenariesFrigates.yaml";
        private Map<Integer, WarpathEliteMercenariesFrigates> cache = (null);

        @Override
        public IMetaCategory<? super WarpathEliteMercenariesFrigates> category() {
        ...
        public String getName() {
            return "WarpathEliteMercenariesFrigates";
        }

        @Override
        public synchronized Map<Integer, WarpathEliteMercenariesFrigates> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(WarpathEliteMercenariesFrigates.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, WarpathEliteMercenariesFrigates> types;
        }
    }
}
