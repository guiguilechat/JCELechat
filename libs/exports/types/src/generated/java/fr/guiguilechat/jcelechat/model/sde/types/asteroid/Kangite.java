    ...
    extends Asteroid
{
    ...
    public static final Kangite.MetaGroup METAGROUP = new Kangite.MetaGroup();
    ...
    @Override
    public IMetaGroup<Kangite> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<Kangite>
    {
        public static final String RESOURCE_PATH = "SDE/types/asteroid/Kangite.yaml";
        private Map<Integer, Kangite> cache = (null);

        @Override
        public IMetaCategory<? super Kangite> category() {
        ...
        @Override
        public synchronized Map<Integer, Kangite> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(Kangite.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, Kangite> types;
        }
    }
}
