...
public class TenzinSCapsuleerOutreachCenterEntities
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<TenzinSCapsuleerOutreachCenterEntities> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<TenzinSCapsuleerOutreachCenterEntities>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/TenzinSCapsuleerOutreachCenterEntities.yaml";
        private Map<Integer, TenzinSCapsuleerOutreachCenterEntities> cache = (null);

        @Override
        public IMetaCategory<? super TenzinSCapsuleerOutreachCenterEntities> category() {
        ...
        public String getName() {
            return "TenzinSCapsuleerOutreachCenterEntities";
        }

        @Override
        public synchronized Map<Integer, TenzinSCapsuleerOutreachCenterEntities> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(TenzinSCapsuleerOutreachCenterEntities.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, TenzinSCapsuleerOutreachCenterEntities> types;
        }
    }
}
