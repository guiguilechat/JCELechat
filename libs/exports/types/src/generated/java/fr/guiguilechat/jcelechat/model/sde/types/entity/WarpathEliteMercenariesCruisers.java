...
public class WarpathEliteMercenariesCruisers
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<WarpathEliteMercenariesCruisers> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<WarpathEliteMercenariesCruisers>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/WarpathEliteMercenariesCruisers.yaml";
        private Map<Integer, WarpathEliteMercenariesCruisers> cache = (null);

        @Override
        public IMetaCategory<? super WarpathEliteMercenariesCruisers> category() {
        ...
        public String getName() {
            return "WarpathEliteMercenariesCruisers";
        }

        @Override
        public synchronized Map<Integer, WarpathEliteMercenariesCruisers> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(WarpathEliteMercenariesCruisers.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, WarpathEliteMercenariesCruisers> types;
        }
    }
}
