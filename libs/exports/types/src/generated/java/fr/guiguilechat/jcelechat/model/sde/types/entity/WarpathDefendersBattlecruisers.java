...
public class WarpathDefendersBattlecruisers
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<WarpathDefendersBattlecruisers> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<WarpathDefendersBattlecruisers>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/WarpathDefendersBattlecruisers.yaml";
        private Map<Integer, WarpathDefendersBattlecruisers> cache = (null);

        @Override
        public IMetaCategory<? super WarpathDefendersBattlecruisers> category() {
        ...
        public String getName() {
            return "WarpathDefendersBattlecruisers";
        }

        @Override
        public synchronized Map<Integer, WarpathDefendersBattlecruisers> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(WarpathDefendersBattlecruisers.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, WarpathDefendersBattlecruisers> types;
        }
    }
}
