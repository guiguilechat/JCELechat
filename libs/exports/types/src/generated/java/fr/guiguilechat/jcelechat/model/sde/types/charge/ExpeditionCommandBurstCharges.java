...
public class ExpeditionCommandBurstCharges
    extends Charge
{
    /**
    ...
    public static final ExpeditionCommandBurstCharges.MetaGroup METAGROUP = new ExpeditionCommandBurstCharges.MetaGroup();
    ...
    @Override
    public IMetaGroup<ExpeditionCommandBurstCharges> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<ExpeditionCommandBurstCharges>
    {
        public static final String RESOURCE_PATH = "SDE/types/charge/ExpeditionCommandBurstCharges.yaml";
        private Map<Integer, ExpeditionCommandBurstCharges> cache = (null);

        @Override
        public IMetaCategory<? super ExpeditionCommandBurstCharges> category() {
        ...
        public String getName() {
            return "ExpeditionCommandBurstCharges";
        }

        @Override
        public synchronized Map<Integer, ExpeditionCommandBurstCharges> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(ExpeditionCommandBurstCharges.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, ExpeditionCommandBurstCharges> types;
        }
    }
}
