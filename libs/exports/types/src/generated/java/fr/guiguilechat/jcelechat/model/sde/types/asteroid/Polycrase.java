    ...
    extends Asteroid
{
    ...
    public static final Polycrase.MetaGroup METAGROUP = new Polycrase.MetaGroup();
    ...
    @Override
    public IMetaGroup<Polycrase> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<Polycrase>
    {
        public static final String RESOURCE_PATH = "SDE/types/asteroid/Polycrase.yaml";
        private Map<Integer, Polycrase> cache = (null);

        @Override
        public IMetaCategory<? super Polycrase> category() {
        ...
        @Override
        public synchronized Map<Integer, Polycrase> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(Polycrase.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, Polycrase> types;
        }
    }
}
