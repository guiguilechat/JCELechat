    ...
    extends Asteroid
{
    ...
    public static final Ducinium.MetaGroup METAGROUP = new Ducinium.MetaGroup();
    ...
    @Override
    public IMetaGroup<Ducinium> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<Ducinium>
    {
        public static final String RESOURCE_PATH = "SDE/types/asteroid/Ducinium.yaml";
        private Map<Integer, Ducinium> cache = (null);

        @Override
        public IMetaCategory<? super Ducinium> category() {
        ...
        @Override
        public synchronized Map<Integer, Ducinium> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(Ducinium.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, Ducinium> types;
        }
    }
}
