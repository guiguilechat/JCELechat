    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {Cpu.INSTANCE, RequiredSkill1Level.INSTANCE, RequiredSkill1 .INSTANCE, TechLevel.INSTANCE, Hp.INSTANCE, MetaLevelOld.INSTANCE, CpuMultiplier.INSTANCE, MetaGroupID.INSTANCE, Power.INSTANCE })));
    ...
    @Override
    public IMetaGroup<CPUEnhancer> getGroup() {
        return METAGROUP;
    }
