...
public class AsteroidSanshaSNationOfficerFrigate
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<AsteroidSanshaSNationOfficerFrigate> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<AsteroidSanshaSNationOfficerFrigate>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/AsteroidSanshaSNationOfficerFrigate.yaml";
        private Map<Integer, AsteroidSanshaSNationOfficerFrigate> cache = (null);

        @Override
        public IMetaCategory<? super AsteroidSanshaSNationOfficerFrigate> category() {
        ...
        public String getName() {
            return "AsteroidSanshaSNationOfficerFrigate";
        }

        @Override
        public synchronized Map<Integer, AsteroidSanshaSNationOfficerFrigate> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AsteroidSanshaSNationOfficerFrigate.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AsteroidSanshaSNationOfficerFrigate> types;
        }
    }
}
