...
public class InterBusYoiulLADs
    extends Entity
{
    /**
    ...
    public static final InterBusYoiulLADs.MetaGroup METAGROUP = new InterBusYoiulLADs.MetaGroup();
    ...
    @Override
    public IMetaGroup<InterBusYoiulLADs> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<InterBusYoiulLADs>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/InterBusYoiulLADs.yaml";
        private Map<Integer, InterBusYoiulLADs> cache = (null);

        @Override
        public IMetaCategory<? super InterBusYoiulLADs> category() {
        ...
        public String getName() {
            return "InterBusYoiulLADs";
        }

        @Override
        public synchronized Map<Integer, InterBusYoiulLADs> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(InterBusYoiulLADs.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, InterBusYoiulLADs> types;
        }
    }
}
