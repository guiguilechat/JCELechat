...
public class WarpathInvadersBattlecruisers
    extends Entity
{
    /**
    ...
    public static final WarpathInvadersBattlecruisers.MetaGroup METAGROUP = new WarpathInvadersBattlecruisers.MetaGroup();
    ...
    @Override
    public IMetaGroup<WarpathInvadersBattlecruisers> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<WarpathInvadersBattlecruisers>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/WarpathInvadersBattlecruisers.yaml";
        private Map<Integer, WarpathInvadersBattlecruisers> cache = (null);

        @Override
        public IMetaCategory<? super WarpathInvadersBattlecruisers> category() {
        ...
        public String getName() {
            return "WarpathInvadersBattlecruisers";
        }

        @Override
        public synchronized Map<Integer, WarpathInvadersBattlecruisers> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(WarpathInvadersBattlecruisers.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, WarpathInvadersBattlecruisers> types;
        }
    }
}
