...
public class WarpathDefendersCruisers
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<WarpathDefendersCruisers> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<WarpathDefendersCruisers>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/WarpathDefendersCruisers.yaml";
        private Map<Integer, WarpathDefendersCruisers> cache = (null);

        @Override
        public IMetaCategory<? super WarpathDefendersCruisers> category() {
        ...
        public String getName() {
            return "WarpathDefendersCruisers";
        }

        @Override
        public synchronized Map<Integer, WarpathDefendersCruisers> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(WarpathDefendersCruisers.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, WarpathDefendersCruisers> types;
        }
    }
}
