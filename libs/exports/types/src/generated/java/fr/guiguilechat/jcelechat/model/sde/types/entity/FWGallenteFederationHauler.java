...
public class FWGallenteFederationHauler
    extends Entity
{
    /**
    ...
    public static final FWGallenteFederationHauler.MetaGroup METAGROUP = new FWGallenteFederationHauler.MetaGroup();
    ...
    @Override
    public IMetaGroup<FWGallenteFederationHauler> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<FWGallenteFederationHauler>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/FWGallenteFederationHauler.yaml";
        private Map<Integer, FWGallenteFederationHauler> cache = (null);

        @Override
        public IMetaCategory<? super FWGallenteFederationHauler> category() {
        ...
        public String getName() {
            return "FWGallenteFederationHauler";
        }

        @Override
        public synchronized Map<Integer, FWGallenteFederationHauler> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(FWGallenteFederationHauler.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, FWGallenteFederationHauler> types;
        }
    }
}
