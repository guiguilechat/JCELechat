...
public class AIRHoloDroneActors
    extends Entity
{
    /**
    ...
    public static final AIRHoloDroneActors.MetaGroup METAGROUP = new AIRHoloDroneActors.MetaGroup();
    ...
    @Override
    public IMetaGroup<AIRHoloDroneActors> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<AIRHoloDroneActors>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/AIRHoloDroneActors.yaml";
        private Map<Integer, AIRHoloDroneActors> cache = (null);

        @Override
        public IMetaCategory<? super AIRHoloDroneActors> category() {
        ...
        public String getName() {
            return "AIRHoloDroneActors";
        }

        @Override
        public synchronized Map<Integer, AIRHoloDroneActors> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AIRHoloDroneActors.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AIRHoloDroneActors> types;
        }
    }
}
