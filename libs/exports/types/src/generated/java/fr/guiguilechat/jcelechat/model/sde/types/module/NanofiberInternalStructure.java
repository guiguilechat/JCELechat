    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {ImplantBonusVelocity.INSTANCE, RequiredSkill1Level.INSTANCE, StructureHPMultiplier.INSTANCE, RequiredSkill1 .INSTANCE, TechLevel.INSTANCE, AgilityMultiplier.INSTANCE, Hp.INSTANCE, MetaLevelOld.INSTANCE, MetaGroupID.INSTANCE })));
