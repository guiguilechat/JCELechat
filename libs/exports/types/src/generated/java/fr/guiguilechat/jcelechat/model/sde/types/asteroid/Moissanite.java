    ...
    extends Asteroid
{
    ...
    @Override
    public IMetaGroup<Moissanite> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<Moissanite>
    {
        public static final String RESOURCE_PATH = "SDE/types/asteroid/Moissanite.yaml";
        private Map<Integer, Moissanite> cache = (null);

        @Override
        public IMetaCategory<? super Moissanite> category() {
        ...
        @Override
        public synchronized Map<Integer, Moissanite> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(Moissanite.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, Moissanite> types;
        }
    }
}
