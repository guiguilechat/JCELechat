...
public class CompressorsBlueprints
    extends Blueprint
{
    /**
    ...
    public static final CompressorsBlueprints.MetaGroup METAGROUP = new CompressorsBlueprints.MetaGroup();
    ...
    @Override
    public IMetaGroup<CompressorsBlueprints> getGroup() {
        return METAGROUP;
    }
