...
public class FWMinmatarRepublicHauler
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<FWMinmatarRepublicHauler> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<FWMinmatarRepublicHauler>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/FWMinmatarRepublicHauler.yaml";
        private Map<Integer, FWMinmatarRepublicHauler> cache = (null);

        @Override
        public IMetaCategory<? super FWMinmatarRepublicHauler> category() {
        ...
        public String getName() {
            return "FWMinmatarRepublicHauler";
        }

        @Override
        public synchronized Map<Integer, FWMinmatarRepublicHauler> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(FWMinmatarRepublicHauler.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, FWMinmatarRepublicHauler> types;
        }
    }
}
