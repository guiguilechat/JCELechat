    ...
    extends Asteroid
{
    ...
    public static final Raspite.MetaGroup METAGROUP = new Raspite.MetaGroup();
    ...
    @Override
    public IMetaGroup<Raspite> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<Raspite>
    {
        public static final String RESOURCE_PATH = "SDE/types/asteroid/Raspite.yaml";
        private Map<Integer, Raspite> cache = (null);

        @Override
        public IMetaCategory<? super Raspite> category() {
        ...
        @Override
        public synchronized Map<Integer, Raspite> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(Raspite.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, Raspite> types;
        }
    }
}
