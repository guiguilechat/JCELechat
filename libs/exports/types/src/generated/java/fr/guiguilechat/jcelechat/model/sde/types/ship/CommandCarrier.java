...
import fr.guiguilechat.jcelechat.model.sde.attributes.ConduitPassengerBonusPercent;
...
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierA1;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierA2;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierA3;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierA5;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierA6;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierC1;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierC2;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierC3;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierC5;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierC6;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierG2;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierG5;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierG6;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierG7;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierM2;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierM5;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierM6;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierM7;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCarrierM8;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCommandCarrierArmorCommand;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCommandCarrierCMJDDuration;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCommandCarrierCMJDShipJumpCap;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCommandCarrierInformationCommand;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCommandCarrierShieldCommand;
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipBonusCommandCarrierSkirmishCommand;
    ...
    extends Ship
{
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int shipbonuscarrierm8;
    @HighIsGood(true)
    @Stackable(true)
    @DefaultIntValue(0)
    public int shipbonuscommandcarrierarmorcommand;
    @HighIsGood(false)
    @Stackable(true)
    @DefaultIntValue(0)
    public int shipbonuscommandcarriercmjdduration;
    @HighIsGood(true)
    @Stackable(true)
    @DefaultIntValue(0)
    public int shipbonuscommandcarriercmjdshipjumpcap;
    @HighIsGood(true)
    @Stackable(true)
    @DefaultIntValue(0)
    public int shipbonuscommandcarrierinformationcommand;
    @HighIsGood(true)
    @Stackable(true)
    @DefaultIntValue(0)
    public int shipbonuscommandcarriershieldcommand;
    @HighIsGood(true)
    @Stackable(true)
    @DefaultIntValue(0)
    public int shipbonuscommandcarrierskirmishcommand;
    /**
    ...
    public Number valueSet(Attribute attribute) {
        switch (attribute.getId()) {
            ...
            case  6207 :
            {
                return shipbonuscommandcarriercmjdduration;
            }
            case  6210 :
            {
                return shipbonuscommandcarriercmjdshipjumpcap;
            }
            case  6193 :
            {
            ...
            case  6194 :
            {
                return shipbonuscommandcarrierskirmishcommand;
            }
            case  2298 :
            {
    ...
    @Override
    public IMetaGroup<CommandCarrier> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<CommandCarrier>
    {
        public static final String RESOURCE_PATH = "SDE/types/ship/CommandCarrier.yaml";
        private Map<Integer, CommandCarrier> cache = (null);

        @Override
        public IMetaCategory<? super CommandCarrier> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public synchronized Map<Integer, CommandCarrier> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(CommandCarrier.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, CommandCarrier> types;
        }
    }
}
