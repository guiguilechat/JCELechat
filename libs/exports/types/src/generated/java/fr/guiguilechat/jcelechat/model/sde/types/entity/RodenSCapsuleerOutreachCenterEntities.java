...
public class RodenSCapsuleerOutreachCenterEntities
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<RodenSCapsuleerOutreachCenterEntities> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<RodenSCapsuleerOutreachCenterEntities>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/RodenSCapsuleerOutreachCenterEntities.yaml";
        private Map<Integer, RodenSCapsuleerOutreachCenterEntities> cache = (null);

        @Override
        public IMetaCategory<? super RodenSCapsuleerOutreachCenterEntities> category() {
        ...
        public String getName() {
            return "RodenSCapsuleerOutreachCenterEntities";
        }

        @Override
        public synchronized Map<Integer, RodenSCapsuleerOutreachCenterEntities> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(RodenSCapsuleerOutreachCenterEntities.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, RodenSCapsuleerOutreachCenterEntities> types;
        }
    }
}
