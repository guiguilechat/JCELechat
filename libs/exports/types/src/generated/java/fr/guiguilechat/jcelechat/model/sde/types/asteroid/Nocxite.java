    ...
    extends Asteroid
{
    ...
    public static final Nocxite.MetaGroup METAGROUP = new Nocxite.MetaGroup();
    ...
    @Override
    public IMetaGroup<Nocxite> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<Nocxite>
    {
        public static final String RESOURCE_PATH = "SDE/types/asteroid/Nocxite.yaml";
        private Map<Integer, Nocxite> cache = (null);

        @Override
        public IMetaCategory<? super Nocxite> category() {
        ...
        @Override
        public synchronized Map<Integer, Nocxite> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(Nocxite.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, Nocxite> types;
        }
    }
}
