...
public class WarpathDefendersFrigates
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<WarpathDefendersFrigates> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<WarpathDefendersFrigates>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/WarpathDefendersFrigates.yaml";
        private Map<Integer, WarpathDefendersFrigates> cache = (null);

        @Override
        public IMetaCategory<? super WarpathDefendersFrigates> category() {
        ...
        public String getName() {
            return "WarpathDefendersFrigates";
        }

        @Override
        public synchronized Map<Integer, WarpathDefendersFrigates> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(WarpathDefendersFrigates.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, WarpathDefendersFrigates> types;
        }
    }
}
