    ...
    extends Asteroid
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {StasisWebifierResistance.INSTANCE, IgnoreMiningWaste.INSTANCE, RequiredSkill1Level.INSTANCE, ReprocessingSkillType.INSTANCE, RequiredSkill1 .INSTANCE, OreBasicType.INSTANCE, AsteroidMetaLevel.INSTANCE, IgnoreMiningCrits.INSTANCE, AsteroidRadiusGrowthFactor.INSTANCE, AsteroidRadiusUnitSize.INSTANCE })));
    public static final Griemeer.MetaGroup METAGROUP = new Griemeer.MetaGroup();
    ...
    @Override
    public IMetaGroup<Griemeer> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<Griemeer>
    {
        public static final String RESOURCE_PATH = "SDE/types/asteroid/Griemeer.yaml";
        private Map<Integer, Griemeer> cache = (null);

        @Override
        public IMetaCategory<? super Griemeer> category() {
        ...
        @Override
        public synchronized Map<Integer, Griemeer> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(Griemeer.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, Griemeer> types;
        }
    }
}
