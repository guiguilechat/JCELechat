...
public class FWCaldariStateHauler
    extends Entity
{
    /**
    ...
    public static final FWCaldariStateHauler.MetaGroup METAGROUP = new FWCaldariStateHauler.MetaGroup();
    ...
    @Override
    public IMetaGroup<FWCaldariStateHauler> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<FWCaldariStateHauler>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/FWCaldariStateHauler.yaml";
        private Map<Integer, FWCaldariStateHauler> cache = (null);

        @Override
        public IMetaCategory<? super FWCaldariStateHauler> category() {
        ...
        public String getName() {
            return "FWCaldariStateHauler";
        }

        @Override
        public synchronized Map<Integer, FWCaldariStateHauler> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(FWCaldariStateHauler.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, FWCaldariStateHauler> types;
        }
    }
}
