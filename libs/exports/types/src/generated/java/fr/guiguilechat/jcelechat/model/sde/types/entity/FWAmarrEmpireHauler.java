...
public class FWAmarrEmpireHauler
    extends Entity
{
    /**
    ...
    public static final FWAmarrEmpireHauler.MetaGroup METAGROUP = new FWAmarrEmpireHauler.MetaGroup();
    ...
    @Override
    public IMetaGroup<FWAmarrEmpireHauler> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<FWAmarrEmpireHauler>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/FWAmarrEmpireHauler.yaml";
        private Map<Integer, FWAmarrEmpireHauler> cache = (null);

        @Override
        public IMetaCategory<? super FWAmarrEmpireHauler> category() {
        ...
        public String getName() {
            return "FWAmarrEmpireHauler";
        }

        @Override
        public synchronized Map<Integer, FWAmarrEmpireHauler> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(FWAmarrEmpireHauler.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, FWAmarrEmpireHauler> types;
        }
    }
}
