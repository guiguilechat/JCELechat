...
import fr.guiguilechat.jcelechat.model.sde.attributes.HiddenLauncherDamageBonus;
...
public class MissileLauncherTorpedo
    extends Module
{
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(1)
    public int hiddenlauncherdamagebonus;
    /**
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {ReloadTime.INSTANCE, TechLevel.INSTANCE, TypeColorScheme.INSTANCE, Hp.INSTANCE, HiddenLauncherDamageBonus.INSTANCE, Slots.INSTANCE, Cpu.INSTANCE, Speed.INSTANCE, RequiredSkill1Level.INSTANCE, OverloadRofBonus.INSTANCE, RequiredSkill1 .INSTANCE, RequiredSkill2Level.INSTANCE, RequiredSkill2 .INSTANCE, ChargeRate.INSTANCE, MetaLevelOld.INSTANCE, ResistanceKiller.INSTANCE, HeatDamage.INSTANCE, ResistanceKillerHull.INSTANCE, HeatAbsorbtionRateModifier.INSTANCE, RequiredThermoDynamicsSkill.INSTANCE, ChargeGroup1 .INSTANCE, MetaGroupID.INSTANCE, Power.INSTANCE, ChargeGroup3 .INSTANCE })));
    public static final MissileLauncherTorpedo.MetaGroup METAGROUP = new MissileLauncherTorpedo.MetaGroup();
    ...
    {
        public static final String RESOURCE_PATH = "SDE/types/module/MissileLauncherTorpedo.yaml";
        private Map<Integer, MissileLauncherTorpedo> cache = (null);
        ...
        public String getName() {
            return "MissileLauncherTorpedo";
        }

        @Override
        public synchronized Map<Integer, MissileLauncherTorpedo> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(MissileLauncherTorpedo.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, MissileLauncherTorpedo> types;
        }
    }
}
