...
public class AsteroidSanshaSNationOfficerCruiser
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<AsteroidSanshaSNationOfficerCruiser> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<AsteroidSanshaSNationOfficerCruiser>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/AsteroidSanshaSNationOfficerCruiser.yaml";
        private Map<Integer, AsteroidSanshaSNationOfficerCruiser> cache = (null);

        @Override
        public IMetaCategory<? super AsteroidSanshaSNationOfficerCruiser> category() {
        ...
        public String getName() {
            return "AsteroidSanshaSNationOfficerCruiser";
        }

        @Override
        public synchronized Map<Integer, AsteroidSanshaSNationOfficerCruiser> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AsteroidSanshaSNationOfficerCruiser.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AsteroidSanshaSNationOfficerCruiser> types;
        }
    }
}
