    ...
    extends Material
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {StasisWebifierResistance.INSTANCE, IgnoreMiningWaste.INSTANCE, RequiredSkill1Level.INSTANCE, RequiredSkill1 .INSTANCE, ReprocessingSkillType.INSTANCE, OreBasicType.INSTANCE, AsteroidMetaLevel.INSTANCE, AsteroidRadiusGrowthFactor.INSTANCE, IgnoreMiningCrits.INSTANCE, AsteroidRadiusUnitSize.INSTANCE })));
    public static final UnrefinedMineral.MetaGroup METAGROUP = new UnrefinedMineral.MetaGroup();
    ...
    @Override
    public IMetaGroup<UnrefinedMineral> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<UnrefinedMineral>
    {
        public static final String RESOURCE_PATH = "SDE/types/material/UnrefinedMineral.yaml";
        private Map<Integer, UnrefinedMineral> cache = (null);

        @Override
        public IMetaCategory<? super UnrefinedMineral> category() {
        ...
        public String getName() {
            return "UnrefinedMineral";
        }

        @Override
        public synchronized Map<Integer, UnrefinedMineral> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(UnrefinedMineral.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, UnrefinedMineral> types;
        }
    }
}
