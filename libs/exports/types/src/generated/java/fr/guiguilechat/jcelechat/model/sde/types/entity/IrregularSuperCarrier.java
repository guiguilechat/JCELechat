    ...
    extends Entity
{
    ...
    @Override
    public IMetaGroup<IrregularSuperCarrier> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<IrregularSuperCarrier>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/IrregularSuperCarrier.yaml";
        private Map<Integer, IrregularSuperCarrier> cache = (null);

        @Override
        public IMetaCategory<? super IrregularSuperCarrier> category() {
        ...
        public String getName() {
            return "IrregularSuperCarrier";
        }

        @Override
        public synchronized Map<Integer, IrregularSuperCarrier> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(IrregularSuperCarrier.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, IrregularSuperCarrier> types;
        }
    }
}
