    ...
    extends Entity
{
    ...
    @Override
    public IMetaGroup<IrregularTitan> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<IrregularTitan>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/IrregularTitan.yaml";
        private Map<Integer, IrregularTitan> cache = (null);

        @Override
        public IMetaCategory<? super IrregularTitan> category() {
        ...
        public String getName() {
            return "IrregularTitan";
        }

        @Override
        public synchronized Map<Integer, IrregularTitan> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(IrregularTitan.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, IrregularTitan> types;
        }
    }
}
