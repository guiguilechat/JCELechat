...
public class WarpathInvadersFrigates
    extends Entity
{
    /**
    ...
    public static final WarpathInvadersFrigates.MetaGroup METAGROUP = new WarpathInvadersFrigates.MetaGroup();
    ...
    @Override
    public IMetaGroup<WarpathInvadersFrigates> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<WarpathInvadersFrigates>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/WarpathInvadersFrigates.yaml";
        private Map<Integer, WarpathInvadersFrigates> cache = (null);

        @Override
        public IMetaCategory<? super WarpathInvadersFrigates> category() {
        ...
        public String getName() {
            return "WarpathInvadersFrigates";
        }

        @Override
        public synchronized Map<Integer, WarpathInvadersFrigates> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(WarpathInvadersFrigates.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, WarpathInvadersFrigates> types;
        }
    }
}
