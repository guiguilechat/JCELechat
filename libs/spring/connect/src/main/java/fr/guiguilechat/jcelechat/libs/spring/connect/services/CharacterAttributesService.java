...
import fr.guiguilechat.jcelechat.libs.spring.connect.model.CharacterAttributes;
import fr.guiguilechat.jcelechat.libs.spring.connect.repositories.CharacterAttributesRepository;
...
public class CharacterAttributesService
	...
	@Override
	protected CharacterAttributes create(int characterId) {
