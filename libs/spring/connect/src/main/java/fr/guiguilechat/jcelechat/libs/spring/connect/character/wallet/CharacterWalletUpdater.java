...
import fr.guiguilechat.jcelechat.libs.spring.connect.generic.CharDataUpdater;
import lombok.Getter;
import lombok.RequiredArgsConstructor;

@Service
@RequiredArgsConstructor(onConstructor = @__(@Lazy))
public class CharacterWalletUpdater
		extends CharDataUpdater<CharacterWallet, Double, CharacterWalletRepository, CharacterWalletService> {
