package fr.guiguilechat.jcelechat.libs.spring.sde.space.star;
...
@Service
@ConfigurationProperties(prefix = "sde.space.star")
public class StarUpdater extends SdeEntityUpdater<Star, StarRepository, StarService, EmapStars> {
