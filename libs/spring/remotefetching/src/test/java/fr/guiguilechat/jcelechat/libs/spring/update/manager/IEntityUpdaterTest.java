...
public class IEntityUpdaterTest {
	...
	public void testPartition() {
		...
		List<List<Integer>> result1 = IEntityUpdater.partition(list1, maxInList).toList();
		...
		List<List<Integer>> result3 = IEntityUpdater.partition(list3, maxInList).toList();
		...
		List<List<Integer>> result10 = IEntityUpdater.partition(list10, maxInList).toList();
