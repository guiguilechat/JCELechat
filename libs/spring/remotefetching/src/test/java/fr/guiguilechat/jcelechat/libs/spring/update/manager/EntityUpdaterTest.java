...
public class EntityUpdaterTest {
	...
	public void testPartition() {
		...
		List<List<Integer>> result1 = EntityUpdater.partition(list1, maxInList).toList();
		...
		List<List<Integer>> result3 = EntityUpdater.partition(list3, maxInList).toList();
		...
		List<List<Integer>> result10 = EntityUpdater.partition(list10, maxInList).toList();
