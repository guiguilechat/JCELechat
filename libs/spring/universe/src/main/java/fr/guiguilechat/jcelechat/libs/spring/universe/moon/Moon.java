...
@Entity(name = "EsiUniverseMoon")
@Table(name = "esi_universe_moon", indexes = {
...
@Getter
@Setter
public class Moon extends ARemoteFetchedResource<Integer, R_get_universe_moons_moon_id> {
	...
	@Override
	public void update(R_get_universe_moons_moon_id data) {
		setName(data.name);
