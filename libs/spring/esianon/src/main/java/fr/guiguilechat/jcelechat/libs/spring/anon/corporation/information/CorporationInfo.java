...
@Entity(name = "EsiCorporationInfo")
@Table(name = "esi_corporation_info", indexes = {
...
@Getter
@Setter
public class CorporationInfo extends RemoteNumberEntity<Integer, R_get_corporations_corporation_id> {
