package fr.guiguilechat.jcelechat.lib.sde.cache.yaml;
...
import fr.guiguilechat.jcelechat.lib.sde.cache.Caching;
import fr.guiguilechat.jcelechat.lib.sde.cache.RemoteMeta;
import fr.guiguilechat.jcelechat.lib.sde.cache.Caching.Ref;
import fr.guiguilechat.jcelechat.lib.sde.cache.parsers.SdeMeta;
import fr.guiguilechat.jcelechat.lib.sde.cache.yaml.DLResult.Cached;
import fr.guiguilechat.jcelechat.lib.sde.cache.yaml.DLResult.Errored;
import fr.guiguilechat.jcelechat.lib.sde.cache.yaml.DLResult.Success;
...
public class YamlCache {
	...
	protected void updateExtract() {
		...
		case Success s: {
			...
			fr.guiguilechat.jcelechat.lib.sde.cache.FileTools.delDir(extractCacheDir());
