...
import fr.guiguilechat.jcelechat.model.esi.compiled.keys.K_16_flag_int_int_Lint_LLint;
...
public class Route {
     ...
     */
    public ObsListHolder<Integer> get(int[] avoid, int[][] connections, int destination, fr.guiguilechat.jcelechat.model.esi.compiled.structures.flag flag, int origin) {
