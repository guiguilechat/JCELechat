...
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_alliances_alliance_id_icons;
...
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_dogma_dynamic_items_type_id_item_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_dogma_effects_effect_id;
...
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_industry_facilities;
...
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_killmails_killmail_id_killmail_hash;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_loyalty_stores_corporation_id_offers;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_markets_groups_market_group_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_markets_prices;
...
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_sovereignty_structures;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_status;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_ancestries;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_asteroid_belts_asteroid_belt_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_bloodlines;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_categories_category_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_constellations_constellation_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_factions;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_graphics_graphic_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_groups_group_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_moons_moon_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_planets_planet_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_races;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_regions_region_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_schematics_schematic_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_stargates_stargate_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_stars_star_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_stations_station_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_system_jumps;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_system_kills;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_systems_system_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_types_type_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_wars_war_id;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_post_characters_affiliation;
import fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_post_universe_ids;
    ...
    extends ITransfer
{
    ...
    public default R_get_alliances_alliance_id_icons get_alliances_icons(int alliance_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_alliances_alliance_id_icons.class));
    }
    ...
    public default R_post_characters_affiliation[] post_affiliation(int[] characters, Map<String, List<String>> headerHandler) {
        ...
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_post_characters_affiliation[].class));
    }
    ...
    public default R_get_characters_character_id_corporationhistory[] get_characters_corporationhistory(int character_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_characters_character_id_corporationhistory[].class));
    }
    ...
    public default R_get_contracts_public_items_contract_id[] get_contracts_public_items(int contract_id, Integer page, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_contracts_public_items_contract_id[].class));
    }
    ...
    public default R_get_contracts_public_region_id[] get_contracts_public(Integer page, int region_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_contracts_public_region_id[].class));
    }
    ...
    public default R_get_corporations_corporation_id_icons get_corporations_icons(int corporation_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_corporations_corporation_id_icons.class));
    }
    ...
    public default R_get_dogma_attributes_attribute_id get_dogma_attributes(int attribute_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_dogma_attributes_attribute_id.class));
    }
    ...
    public default R_get_dogma_dynamic_items_type_id_item_id get_dogma_dynamic_items(long item_id, int type_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_dogma_dynamic_items_type_id_item_id.class));
    }
    ...
    public default M_get_fw_leaderboards_2 get_fw_leaderboards(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.M_get_fw_leaderboards_2.class));
    }
    ...
    public default R_get_fw_stats[] get_fw_stats(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_fw_stats[].class));
    }
    ...
    public default R_get_fw_wars[] get_fw_wars(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_fw_wars[].class));
    }
    ...
    public default R_get_incursions[] get_incursions(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_incursions[].class));
    }
    ...
    public default R_get_industry_facilities[] get_industry_facilities(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_industry_facilities[].class));
    }
    ...
    public default R_get_industry_systems[] get_industry_systems(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_industry_systems[].class));
    }
    ...
    public default R_get_insurance_prices[] get_insurance_prices(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_insurance_prices[].class));
    }
    ...
    public default R_get_killmails_killmail_id_killmail_hash get_killmails(String killmail_hash, int killmail_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_killmails_killmail_id_killmail_hash.class));
    }
    ...
    public default R_get_loyalty_stores_corporation_id_offers[] get_loyalty_stores_offers(int corporation_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_loyalty_stores_corporation_id_offers[].class));
    }
    ...
    public default R_get_markets_groups_market_group_id get_markets_groups(int market_group_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_markets_groups_market_group_id.class));
    }
    ...
    public default R_get_markets_prices[] get_markets_prices(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_markets_prices[].class));
    }
    ...
    public default R_get_markets_region_id_history[] get_markets_history(int region_id, int type_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_markets_region_id_history[].class));
    }
     ...
     */
    public default R_get_markets_region_id_orders[] get_markets_orders(fr.guiguilechat.jcelechat.model.jcesi.compiled.structures.order_type order_type, Integer page, int region_id, Integer type_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_markets_region_id_orders[].class));
    }
    ...
    public default R_get_opportunities_groups_group_id get_opportunities_groups(int group_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_opportunities_groups_group_id.class));
    }
    ...
    public default R_get_opportunities_tasks_task_id get_opportunities_tasks(int task_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_opportunities_tasks_task_id.class));
    }
     ...
     */
    public default int[] get_route(int[] avoid, int[][] connections, int destination, fr.guiguilechat.jcelechat.model.jcesi.compiled.structures.flag flag, int origin, Map<String, List<String>> headerHandler) {
    ...
    public default R_get_sovereignty_campaigns[] get_sovereignty_campaigns(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_sovereignty_campaigns[].class));
    }
    ...
    public default R_get_sovereignty_map[] get_sovereignty_map(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_sovereignty_map[].class));
    }
    ...
    public default R_get_sovereignty_structures[] get_sovereignty_structures(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_sovereignty_structures[].class));
    }
    ...
    public default R_get_status get_status(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_status.class));
    }
    ...
    public default R_get_universe_ancestries[] get_universe_ancestries(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_ancestries[].class));
    }
    ...
    public default R_get_universe_asteroid_belts_asteroid_belt_id get_universe_asteroid_belts(int asteroid_belt_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_asteroid_belts_asteroid_belt_id.class));
    }
    ...
    public default R_get_universe_bloodlines[] get_universe_bloodlines(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_bloodlines[].class));
    }
    ...
    public default R_get_universe_categories_category_id get_universe_categories(int category_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_categories_category_id.class));
    }
    ...
    public default R_get_universe_constellations_constellation_id get_universe_constellations(int constellation_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_constellations_constellation_id.class));
    }
    ...
    public default R_get_universe_graphics_graphic_id get_universe_graphics(int graphic_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_graphics_graphic_id.class));
    }
    ...
    public default R_get_universe_groups_group_id get_universe_groups(int group_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_groups_group_id.class));
    }
    ...
    public default R_post_universe_ids post_universe_ids(String[] names, Map<String, List<String>> headerHandler) {
        ...
        String fetched = connectPost(url, content, headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_post_universe_ids.class));
    }
    ...
    public default R_get_universe_moons_moon_id get_universe_moons(int moon_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_moons_moon_id.class));
    }
    ...
    public default R_get_universe_planets_planet_id get_universe_planets(int planet_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_planets_planet_id.class));
    }
    ...
    public default R_get_universe_races[] get_universe_races(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_races[].class));
    }
    ...
    public default R_get_universe_regions_region_id get_universe_regions(int region_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_regions_region_id.class));
    }
    ...
    public default R_get_universe_schematics_schematic_id get_universe_schematics(int schematic_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_schematics_schematic_id.class));
    }
    ...
    public default R_get_universe_stargates_stargate_id get_universe_stargates(int stargate_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_stargates_stargate_id.class));
    }
    ...
    public default R_get_universe_stars_star_id get_universe_stars(int star_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_stars_star_id.class));
    }
    ...
    public default R_get_universe_system_jumps[] get_universe_system_jumps(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_system_jumps[].class));
    }
    ...
    public default R_get_wars_war_id get_wars(int war_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_wars_war_id.class));
    }
    ...
    public default R_get_characters_character_id_portrait get_characters_portrait(int character_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_characters_character_id_portrait.class));
    }
    ...
    public default R_get_corporations_corporation_id_alliancehistory[] get_corporations_alliancehistory(int corporation_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_corporations_corporation_id_alliancehistory[].class));
    }
    ...
    public default R_get_dogma_effects_effect_id get_dogma_effects(int effect_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_dogma_effects_effect_id.class));
    }
    ...
    public default R_get_fw_systems[] get_fw_systems(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_fw_systems[].class));
    }
    ...
    public default R_get_search get(String[] categories, String search, Boolean strict, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_search.class));
    }
    ...
    public default R_get_universe_factions[] get_universe_factions(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_factions[].class));
    }
    ...
    public default R_post_universe_names[] post_universe_names(int[] ids, Map<String, List<String>> headerHandler) {
        ...
        content.put("ids", ids);
        String fetched = connectPost(url, content, headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_post_universe_names[].class));
    }
    ...
    public default R_get_universe_stations_station_id get_universe_stations(int station_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_stations_station_id.class));
    }
    ...
    public default R_get_universe_system_kills[] get_universe_system_kills(Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_system_kills[].class));
    }
    ...
    public default R_get_alliances_alliance_id get_alliances(int alliance_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_alliances_alliance_id.class));
    }
    ...
    public default R_get_universe_types_type_id get_universe_types(int type_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_types_type_id.class));
    }
    ...
    public default R_get_characters_character_id get_characters(int character_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_characters_character_id.class));
    }
    ...
    public default R_get_corporations_corporation_id get_corporations(int corporation_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_corporations_corporation_id.class));
    }
    ...
    public default R_get_universe_systems_system_id get_universe_systems(int system_id, Map<String, List<String>> headerHandler) {
        ...
        String fetched=connectGet(url,headerHandler);
        return convert((fetched), (fr.guiguilechat.jcelechat.model.jcesi.compiled.responses.R_get_universe_systems_system_id.class));
    }
}
