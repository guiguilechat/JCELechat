...
public class K_16_flag_int_int_Lint_LLint {
    public final fr.guiguilechat.jcelechat.model.jcesi.compiled.structures.flag flag;
    public final int origin;
    public final int destination;
    public final int[] avoid;
    public final int[][] connections;

    public K_16_flag_int_int_Lint_LLint(fr.guiguilechat.jcelechat.model.jcesi.compiled.structures.flag flag, int origin, int destination, int[] avoid, int[][] connections) {
        this.flag = flag;
        this.origin = origin;
