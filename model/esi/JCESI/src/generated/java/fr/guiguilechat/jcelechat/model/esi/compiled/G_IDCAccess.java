    ...
    extends ITransfer
{
     ...
     */
    public default R_get_markets_region_id_orders[] get_markets_orders(fr.guiguilechat.jcelechat.model.esi.compiled.structures.order_type order_type, Integer page, int region_id, Integer type_id, Map<String, List<String>> headerHandler) {
     ...
     */
    public default int[] get_route(int[] avoid, int[][] connections, int destination, fr.guiguilechat.jcelechat.model.esi.compiled.structures.flag flag, int origin, Map<String, List<String>> headerHandler) {
