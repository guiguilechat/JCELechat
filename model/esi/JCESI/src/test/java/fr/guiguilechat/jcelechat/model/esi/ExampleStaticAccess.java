...
import fr.guiguilechat.jcelechat.model.esi.compiled.structures.order_type;
...
public class ExampleStaticAccess {
	...
	public static void main(String[] args) {
		...
		ObsListHolder<R_get_markets_region_id_orders> cachebos = stat.cache.markets
				.orders(fr.guiguilechat.jcelechat.model.esi.compiled.structures.order_type.buy, theforge,
						veldspar);
