...
/**
 * interface for the basic capacities to<br /><ul><li>send GET|PUT|POST|DELETE requests</li><li>convert a string into a class</li><li>flatten object into url parameter</li></ul>
 */
public interface G_ITransfer {
