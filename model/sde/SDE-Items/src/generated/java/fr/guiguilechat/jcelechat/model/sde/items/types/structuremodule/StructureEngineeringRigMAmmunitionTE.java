    ...
    extends StructureModule
{
    ...
    private static Map<String, StructureEngineeringRigMAmmunitionTE> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMAmmunitionTE> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StructureEngineeringRigMAmmunitionTE> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMAmmunitionTE>
    {

        @Override
        public MetaCategory<? super StructureEngineeringRigMAmmunitionTE> category() {
        ...
        @Override
        public Collection<StructureEngineeringRigMAmmunitionTE> items() {
            return (load().values());
        }
    }
}
