    ...
    extends Asteroid
{
    ...
    private static Map<String, Veldspar> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Veldspar> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, Veldspar> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Veldspar>
    {

        @Override
        public MetaCategory<? super Veldspar> category() {
        ...
        @Override
        public Collection<Veldspar> items() {
            return (load().values());
        }
    }
}
