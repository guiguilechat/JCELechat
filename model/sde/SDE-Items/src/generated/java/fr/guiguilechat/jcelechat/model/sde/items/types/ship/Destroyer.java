    ...
    extends Ship
{
    ...
    private static Map<String, Destroyer> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Destroyer> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, Destroyer> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Destroyer>
    {

        @Override
        public MetaCategory<? super Destroyer> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public Collection<Destroyer> items() {
            return (load().values());
        }
    }
}
