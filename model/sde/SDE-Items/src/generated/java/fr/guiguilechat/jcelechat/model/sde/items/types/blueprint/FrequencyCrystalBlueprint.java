    ...
    extends Blueprint
{
    ...
    private static Map<String, FrequencyCrystalBlueprint> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<FrequencyCrystalBlueprint> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, FrequencyCrystalBlueprint> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<FrequencyCrystalBlueprint>
    {

        @Override
        public MetaCategory<? super FrequencyCrystalBlueprint> category() {
        ...
        @Override
        public Collection<FrequencyCrystalBlueprint> items() {
            return (load().values());
        }
    }
}
