    ...
    extends Module
{
    ...
    private static Map<String, ShieldPowerRelay> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ShieldPowerRelay> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, ShieldPowerRelay> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ShieldPowerRelay>
    {

        @Override
        public MetaCategory<? super ShieldPowerRelay> category() {
        ...
        @Override
        public Collection<ShieldPowerRelay> items() {
            return (load().values());
        }
    }
}
