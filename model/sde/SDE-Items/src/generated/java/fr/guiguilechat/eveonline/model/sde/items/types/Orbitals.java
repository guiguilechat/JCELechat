    ...
    extends Item
{
    ...
    public static Map<String, ? extends Orbitals> loadCategory() {
        return Stream.of(TestOrbitals.load(), OrbitalConstructionPlatform.load(), OrbitalInfrastructure.load()).flatMap((m -> m.entrySet().stream())).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
    }
}
