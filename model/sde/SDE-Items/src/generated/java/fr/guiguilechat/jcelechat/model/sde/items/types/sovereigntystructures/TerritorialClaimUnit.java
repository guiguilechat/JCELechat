    ...
    extends SovereigntyStructures
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<TerritorialClaimUnit> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<TerritorialClaimUnit>
    {

        @Override
        public MetaCategory<? super TerritorialClaimUnit> category() {
        ...
        @Override
        public Collection<TerritorialClaimUnit> items() {
            return (load().values());
        }
    }
}
