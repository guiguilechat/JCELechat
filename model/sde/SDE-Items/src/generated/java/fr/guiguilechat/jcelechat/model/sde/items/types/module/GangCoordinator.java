    ...
    extends Module
{
    ...
    @Override
    public IMetaGroup<GangCoordinator> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<GangCoordinator>
    {
        public final static String RESOURCE_PATH = "SDE/items/module/GangCoordinator.yaml";
        private Map<String, GangCoordinator> cache = (null);

        @Override
        public IMetaCategory<? super GangCoordinator> category() {
        ...
        @Override
        public synchronized Map<String, GangCoordinator> load() {
            if (cache == null) {
                try {
