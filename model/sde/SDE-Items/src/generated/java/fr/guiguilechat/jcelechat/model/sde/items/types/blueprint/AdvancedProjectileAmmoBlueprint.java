    ...
    extends Blueprint
{
    ...
    private static Map<String, AdvancedProjectileAmmoBlueprint> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<AdvancedProjectileAmmoBlueprint> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, AdvancedProjectileAmmoBlueprint> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<AdvancedProjectileAmmoBlueprint>
    {

        @Override
        public MetaCategory<? super AdvancedProjectileAmmoBlueprint> category() {
        ...
        @Override
        public Collection<AdvancedProjectileAmmoBlueprint> items() {
            return (load().values());
        }
    }
}
