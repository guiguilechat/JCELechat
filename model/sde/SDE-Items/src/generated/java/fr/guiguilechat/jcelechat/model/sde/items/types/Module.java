    ...
    extends Item
{
        ...
        implements IMetaCategory<Module>
    {
        ...
        public Map<String, Module> load() {
            HashMap<String, Module> ret = new HashMap<>();
