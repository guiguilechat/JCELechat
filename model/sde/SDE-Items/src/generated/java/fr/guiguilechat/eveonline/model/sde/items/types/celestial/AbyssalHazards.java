    ...
    extends Celestial
{
    ...
    public final static String RESOURCE_PATH = "SDE/items/celestial/AbyssalHazards.yaml";
    private static LinkedHashMap<String, AbyssalHazards> cache = (null);
    ...
    public static synchronized LinkedHashMap<String, AbyssalHazards> load() {
        if (cache == null) {
            try {
                cache = new Yaml().loadAs(new InputStreamReader(AbyssalHazards.class.getClassLoader().getResourceAsStream((RESOURCE_PATH))), (Container.class)).items;
    ...
    private static class Container {
        public LinkedHashMap<String, AbyssalHazards> items;
    }
}
