    ...
    extends Subsystem
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<PropulsionSystems> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<PropulsionSystems>
    {

        @Override
        public MetaCategory<? super PropulsionSystems> category() {
        ...
        @Override
        public Collection<PropulsionSystems> items() {
            return (load().values());
        }
    }
}
