    ...
    extends Ship
{
    ...
    private static Map<String, AssaultFrigate> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<AssaultFrigate> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, AssaultFrigate> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<AssaultFrigate>
    {

        @Override
        public MetaCategory<? super AssaultFrigate> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public Collection<AssaultFrigate> items() {
            return (load().values());
        }
    }
}
