    ...
    extends PlanetaryCommodities
{
    ...
    private static LinkedHashMap<String, SpecializedCommoditiesTier3> cache = (null);
    ...
    public static synchronized LinkedHashMap<String, SpecializedCommoditiesTier3> load() {
        if (cache == null) {
            try {
