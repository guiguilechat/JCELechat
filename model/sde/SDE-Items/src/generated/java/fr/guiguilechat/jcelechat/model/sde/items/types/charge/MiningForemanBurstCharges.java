    ...
    extends Charge
{
    ...
    private static Map<String, MiningForemanBurstCharges> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<MiningForemanBurstCharges> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, MiningForemanBurstCharges> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<MiningForemanBurstCharges>
    {

        @Override
        public MetaCategory<? super MiningForemanBurstCharges> category() {
        ...
        @Override
        public Collection<MiningForemanBurstCharges> items() {
            return (load().values());
        }
    }
}
