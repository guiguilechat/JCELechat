    ...
    extends Blueprint
{
    ...
    private static Map<String, StrategicCruiserBlueprints> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StrategicCruiserBlueprints> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StrategicCruiserBlueprints> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StrategicCruiserBlueprints>
    {

        @Override
        public MetaCategory<? super StrategicCruiserBlueprints> category() {
        ...
        @Override
        public Collection<StrategicCruiserBlueprints> items() {
            return (load().values());
        }
    }
}
