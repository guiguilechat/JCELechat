    ...
    extends Ship
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Interceptor> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Interceptor>
    {

        @Override
        public MetaCategory<? super Interceptor> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public Collection<Interceptor> items() {
            return (load().values());
        }
    }
}
