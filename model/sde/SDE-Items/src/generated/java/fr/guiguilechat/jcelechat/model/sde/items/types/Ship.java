...
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.AssaultFrigate;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.AttackBattlecruiser;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Battleship;
...
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.CommandDestroyer;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.CommandShip;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Corvette;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.CovertOps;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Cruiser;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.DeepSpaceTransport;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Destroyer;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Dreadnought;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.ElectronicAttackShip;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Exhumer;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.ExpeditionFrigate;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.FlagCruiser;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.ForceAuxiliary;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.ForceReconShip;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Freighter;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Frigate;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.HeavyAssaultCruiser;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.HeavyInterdictionCruiser;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Industrial;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.IndustrialCommandShip;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Interceptor;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Interdictor;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.JumpFreighter;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Logistics;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.LogisticsFrigate;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Marauder;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.MiningBarge;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.PrototypeExplorationShip;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Shuttle;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.StealthBomber;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.StrategicCruiser;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Supercarrier;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.TacticalDestroyer;
import fr.guiguilechat.jcelechat.model.sde.items.types.ship.Titan;
