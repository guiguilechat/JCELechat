    ...
    extends Blueprint
{
    ...
    @Override
    public IMetaGroup<UnknownBlueprint> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<UnknownBlueprint>
    {
        public final static String RESOURCE_PATH = "SDE/items/blueprint/UnknownBlueprint.yaml";
        private Map<String, UnknownBlueprint> cache = (null);

        @Override
        public IMetaCategory<? super UnknownBlueprint> category() {
        ...
        @Override
        public synchronized Map<String, UnknownBlueprint> load() {
            if (cache == null) {
                try {
