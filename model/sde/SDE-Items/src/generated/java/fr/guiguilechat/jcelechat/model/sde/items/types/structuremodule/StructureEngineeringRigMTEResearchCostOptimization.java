    ...
    extends StructureModule
{
    ...
    private static Map<String, StructureEngineeringRigMTEResearchCostOptimization> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMTEResearchCostOptimization> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StructureEngineeringRigMTEResearchCostOptimization> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMTEResearchCostOptimization>
    {

        @Override
        public MetaCategory<? super StructureEngineeringRigMTEResearchCostOptimization> category() {
        ...
        @Override
        public Collection<StructureEngineeringRigMTEResearchCostOptimization> items() {
            return (load().values());
        }
    }
}
