    ...
    extends Asteroid
{
    ...
    private static Map<String, Hedbergite> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Hedbergite> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, Hedbergite> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Hedbergite>
    {

        @Override
        public MetaCategory<? super Hedbergite> category() {
        ...
        @Override
        public Collection<Hedbergite> items() {
            return (load().values());
        }
    }
}
