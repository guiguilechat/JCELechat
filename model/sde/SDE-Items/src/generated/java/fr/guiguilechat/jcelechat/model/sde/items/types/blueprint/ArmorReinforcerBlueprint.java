    ...
    extends Blueprint
{
    ...
    private static Map<String, ArmorReinforcerBlueprint> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ArmorReinforcerBlueprint> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, ArmorReinforcerBlueprint> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ArmorReinforcerBlueprint>
    {

        @Override
        public MetaCategory<? super ArmorReinforcerBlueprint> category() {
        ...
        @Override
        public Collection<ArmorReinforcerBlueprint> items() {
            return (load().values());
        }
    }
}
