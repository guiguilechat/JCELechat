    ...
    extends StructureModule
{
    ...
    private static Map<String, StructureCombatRigMMissileApplication> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureCombatRigMMissileApplication> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StructureCombatRigMMissileApplication> load() {
        if (cache == null) {
            try {
    ...
    private static class Container {
        public LinkedHashMap<String, StructureCombatRigMMissileApplication> items;
    }

    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureCombatRigMMissileApplication>
    {

        @Override
        public MetaCategory<? super StructureCombatRigMMissileApplication> category() {
        ...
        @Override
        public Collection<StructureCombatRigMMissileApplication> items() {
            return (load().values());
        }
    }
}
