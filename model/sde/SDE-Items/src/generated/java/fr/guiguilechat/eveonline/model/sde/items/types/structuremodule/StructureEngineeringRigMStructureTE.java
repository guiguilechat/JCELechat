    ...
    extends StructureModule
{
    ...
    private static LinkedHashMap<String, StructureEngineeringRigMStructureTE> cache = (null);
    ...
    public static synchronized LinkedHashMap<String, StructureEngineeringRigMStructureTE> load() {
        if (cache == null) {
            try {
