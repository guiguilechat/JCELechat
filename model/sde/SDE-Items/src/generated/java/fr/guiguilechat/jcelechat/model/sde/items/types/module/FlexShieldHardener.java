    ...
    extends Module
{
    ...
    private static Map<String, FlexShieldHardener> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<FlexShieldHardener> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, FlexShieldHardener> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<FlexShieldHardener>
    {

        @Override
        public MetaCategory<? super FlexShieldHardener> category() {
        ...
        @Override
        public Collection<FlexShieldHardener> items() {
            return (load().values());
        }
    }
}
