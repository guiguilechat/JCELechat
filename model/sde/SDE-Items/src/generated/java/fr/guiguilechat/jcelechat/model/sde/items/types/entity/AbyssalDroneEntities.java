    ...
    extends Entity
{
    ...
    private static LinkedHashMap<String, AbyssalDroneEntities> cache = (null);
    ...
    public Class<?> getGroup() {
        return AbyssalDroneEntities.class;
    }

    public static synchronized LinkedHashMap<String, AbyssalDroneEntities> load() {
        if (cache == null) {
            try {
