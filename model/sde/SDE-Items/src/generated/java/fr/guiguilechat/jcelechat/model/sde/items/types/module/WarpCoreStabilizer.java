    ...
    extends Module
{
    ...
    private static Map<String, WarpCoreStabilizer> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<WarpCoreStabilizer> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, WarpCoreStabilizer> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<WarpCoreStabilizer>
    {

        @Override
        public MetaCategory<? super WarpCoreStabilizer> category() {
        ...
        @Override
        public Collection<WarpCoreStabilizer> items() {
            return (load().values());
        }
    }
}
