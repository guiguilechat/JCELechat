    ...
    extends StructureModule
{
    ...
    public final static StructureEngineeringRigMDroneAndFighterME.MetaGroup METAGROUP = new StructureEngineeringRigMDroneAndFighterME.MetaGroup();
    public final static String RESOURCE_PATH = "SDE/items/structuremodule/StructureEngineeringRigMDroneAndFighterME.yaml";
    private static Map<String, StructureEngineeringRigMDroneAndFighterME> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMDroneAndFighterME> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StructureEngineeringRigMDroneAndFighterME> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMDroneAndFighterME>
    {

        @Override
        public MetaCategory<? super StructureEngineeringRigMDroneAndFighterME> category() {
        ...
        @Override
        public Collection<StructureEngineeringRigMDroneAndFighterME> items() {
            return (load().values());
        }
    }
}
