...
public class SeekerScouts
    extends Entity
{
    public final static SeekerScouts.MetaGroup METAGROUP = new SeekerScouts.MetaGroup();
    ...
    {
        public final static String RESOURCE_PATH = "SDE/items/entity/SeekerScouts.yaml";
