    ...
    extends Blueprint
{
    ...
    private static Map<String, GunneryUpgradeBlueprint> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<GunneryUpgradeBlueprint> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, GunneryUpgradeBlueprint> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<GunneryUpgradeBlueprint>
    {

        @Override
        public MetaCategory<? super GunneryUpgradeBlueprint> category() {
        ...
        @Override
        public Collection<GunneryUpgradeBlueprint> items() {
            return (load().values());
        }
    }
}
