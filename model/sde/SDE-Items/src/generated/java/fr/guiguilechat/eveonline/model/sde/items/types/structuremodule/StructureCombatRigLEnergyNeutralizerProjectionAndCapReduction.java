    ...
    extends StructureModule
{
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double StructureRigEwarOptimalBonus;
    /**
     * 
     * 
     */
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double StructureRigEwarFalloffBonus;
    /**
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double StructureRigEwarCapUseBonus;
    /**
     * 
     * 
     */
    ...
    private static LinkedHashMap<String, StructureCombatRigLEnergyNeutralizerProjectionAndCapReduction> cache = (null);
    ...
    public Class<?> getGroup() {
        return StructureCombatRigLEnergyNeutralizerProjectionAndCapReduction.class;
    }

    public static LinkedHashMap<String, StructureCombatRigLEnergyNeutralizerProjectionAndCapReduction> load() {
        if ((cache==null)) {
            try {
