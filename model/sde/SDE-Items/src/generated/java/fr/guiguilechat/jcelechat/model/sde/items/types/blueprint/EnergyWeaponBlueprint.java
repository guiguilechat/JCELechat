...
public class EnergyWeaponBlueprint
    extends Blueprint
{
    /**
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<EnergyWeaponBlueprint> getGroup() {
        return METAGROUP;
    }
    ...
    private static class Container {
        public LinkedHashMap<String, EnergyWeaponBlueprint> items;
    }

    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<EnergyWeaponBlueprint>
    {

        @Override
        public MetaCategory<? super EnergyWeaponBlueprint> category() {
            return Blueprint.METACAT;
        }

        @Override
        public String getName() {
            return "EnergyWeaponBlueprint";
        }

        @Override
        public Collection<EnergyWeaponBlueprint> items() {
            return (load().values());
        }
    }
}
