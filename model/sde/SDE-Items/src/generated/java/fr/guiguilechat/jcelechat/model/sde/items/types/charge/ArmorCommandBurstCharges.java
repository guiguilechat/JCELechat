    ...
    extends Charge
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ArmorCommandBurstCharges> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ArmorCommandBurstCharges>
    {

        @Override
        public MetaCategory<? super ArmorCommandBurstCharges> category() {
        ...
        @Override
        public Collection<ArmorCommandBurstCharges> items() {
            return (load().values());
        }
    }
}
