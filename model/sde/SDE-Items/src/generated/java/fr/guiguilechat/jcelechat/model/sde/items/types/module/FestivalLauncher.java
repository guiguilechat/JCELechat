    ...
    extends Module
{
    ...
    private static Map<String, FestivalLauncher> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<FestivalLauncher> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, FestivalLauncher> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<FestivalLauncher>
    {

        @Override
        public MetaCategory<? super FestivalLauncher> category() {
        ...
        @Override
        public Collection<FestivalLauncher> items() {
            return (load().values());
        }
    }
}
