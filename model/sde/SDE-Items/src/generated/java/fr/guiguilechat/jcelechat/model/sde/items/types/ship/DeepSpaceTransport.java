    ...
    extends Ship
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<DeepSpaceTransport> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<DeepSpaceTransport>
    {

        @Override
        public MetaCategory<? super DeepSpaceTransport> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public Collection<DeepSpaceTransport> items() {
            return (load().values());
        }
    }
}
