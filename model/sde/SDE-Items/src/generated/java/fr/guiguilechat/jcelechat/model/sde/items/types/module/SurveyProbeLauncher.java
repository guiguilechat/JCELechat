    ...
    extends Module
{
    ...
    private static Map<String, SurveyProbeLauncher> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<SurveyProbeLauncher> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, SurveyProbeLauncher> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<SurveyProbeLauncher>
    {

        @Override
        public MetaCategory<? super SurveyProbeLauncher> category() {
        ...
        @Override
        public Collection<SurveyProbeLauncher> items() {
            return (load().values());
        }
    }
}
