    ...
    extends Item
{
        ...
        implements IMetaCategory<Blueprint>
    {
        ...
        @Override
        public Map<String, Blueprint> load() {
            HashMap<String, Blueprint> ret = new HashMap<>();
