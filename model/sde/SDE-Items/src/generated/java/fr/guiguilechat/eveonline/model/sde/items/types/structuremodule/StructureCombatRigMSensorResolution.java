...
public class StructureCombatRigMSensorResolution
    extends StructureModule
{
    ...
    @Stackable(false)
    @DefaultValue(0.0D)
    public double StructureRigScanResBonus;
    /**
    ...
    public final static String RESOURCE_PATH = "SDE/items/structuremodule/StructureCombatRigMSensorResolution.yaml";
    private static LinkedHashMap<String, StructureCombatRigMSensorResolution> cache = (null);
    ...
    private static class Container {
        ...
        public LinkedHashMap<String, StructureCombatRigMSensorResolution> items;
