    ...
    extends Ship
{
    ...
    private static Map<String, StrategicCruiser> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StrategicCruiser> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StrategicCruiser> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StrategicCruiser>
    {

        @Override
        public MetaCategory<? super StrategicCruiser> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public Collection<StrategicCruiser> items() {
            return (load().values());
        }
    }
}
