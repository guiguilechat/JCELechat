    ...
    extends Module
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<BallisticControlSystem> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<BallisticControlSystem>
    {

        @Override
        public MetaCategory<? super BallisticControlSystem> category() {
        ...
        @Override
        public Collection<BallisticControlSystem> items() {
            return (load().values());
        }
    }
}
