    ...
    extends Module
{
    ...
    private static Map<String, CapacitorBooster> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<CapacitorBooster> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, CapacitorBooster> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<CapacitorBooster>
    {

        @Override
        public MetaCategory<? super CapacitorBooster> category() {
        ...
        @Override
        public Collection<CapacitorBooster> items() {
            return (load().values());
        }
    }
}
