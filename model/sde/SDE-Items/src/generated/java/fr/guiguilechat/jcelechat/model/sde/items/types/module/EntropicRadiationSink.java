    ...
    extends Module
{
    ...
    private static LinkedHashMap<String, EntropicRadiationSink> cache = (null);
    ...
    public Class<?> getGroup() {
        return EntropicRadiationSink.class;
    }

    public static synchronized LinkedHashMap<String, EntropicRadiationSink> load() {
        if (cache == null) {
            try {
