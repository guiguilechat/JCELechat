    ...
    extends StructureModule
{
    ...
    public final static StructureEngineeringRigMAmmunitionME.MetaGroup METAGROUP = new StructureEngineeringRigMAmmunitionME.MetaGroup();
    public final static String RESOURCE_PATH = "SDE/items/structuremodule/StructureEngineeringRigMAmmunitionME.yaml";
    private static Map<String, StructureEngineeringRigMAmmunitionME> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMAmmunitionME> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StructureEngineeringRigMAmmunitionME> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMAmmunitionME>
    {

        @Override
        public MetaCategory<? super StructureEngineeringRigMAmmunitionME> category() {
            return StructureModule.METACAT;
        }

        @Override
        public String getName() {
            return "StructureEngineeringRigMAmmunitionME";
        }

        @Override
        public Collection<StructureEngineeringRigMAmmunitionME> items() {
            return (load().values());
        }
    }
}
