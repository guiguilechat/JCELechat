    ...
    extends StructureModule
{
    ...
    public final static StructureResourceRigMIceReprocessing.MetaGroup METAGROUP = new StructureResourceRigMIceReprocessing.MetaGroup();
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureResourceRigMIceReprocessing> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureResourceRigMIceReprocessing>
    {

        @Override
        public MetaCategory<? super StructureResourceRigMIceReprocessing> category() {
        ...
        @Override
        public Collection<StructureResourceRigMIceReprocessing> items() {
            return (load().values());
        }
    }
}
