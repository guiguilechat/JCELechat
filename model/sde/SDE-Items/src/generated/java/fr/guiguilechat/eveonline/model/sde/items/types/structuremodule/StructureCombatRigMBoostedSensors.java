    ...
    extends StructureModule
{
    ...
    private static LinkedHashMap<String, StructureCombatRigMBoostedSensors> cache = (null);
    ...
    public static synchronized LinkedHashMap<String, StructureCombatRigMBoostedSensors> load() {
        if (cache == null) {
            try {
