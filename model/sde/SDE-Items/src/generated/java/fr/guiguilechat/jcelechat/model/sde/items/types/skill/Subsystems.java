    ...
    extends Skill
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Subsystems> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Subsystems>
    {

        @Override
        public MetaCategory<? super Subsystems> category() {
        ...
        @Override
        public Collection<Subsystems> items() {
            return (load().values());
        }
    }
}
