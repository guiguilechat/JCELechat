    ...
    extends Implant
{
    ...
    private static Map<String, SpecialEditionImplant> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<SpecialEditionImplant> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, SpecialEditionImplant> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<SpecialEditionImplant>
    {

        @Override
        public MetaCategory<? super SpecialEditionImplant> category() {
        ...
        @Override
        public Collection<SpecialEditionImplant> items() {
            return (load().values());
        }
    }
}
