    ...
    extends Module
{
    ...
    private static Map<String, ArmorRepairUnit> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ArmorRepairUnit> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, ArmorRepairUnit> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ArmorRepairUnit>
    {

        @Override
        public MetaCategory<? super ArmorRepairUnit> category() {
        ...
        @Override
        public Collection<ArmorRepairUnit> items() {
            return (load().values());
        }
    }
}
