    ...
    extends Skill
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ElectronicSystems> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ElectronicSystems>
    {

        @Override
        public MetaCategory<? super ElectronicSystems> category() {
        ...
        @Override
        public Collection<ElectronicSystems> items() {
            return (load().values());
        }
    }
}
