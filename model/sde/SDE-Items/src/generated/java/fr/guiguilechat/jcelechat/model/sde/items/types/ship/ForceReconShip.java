    ...
    extends Ship
{
    ...
    private static Map<String, ForceReconShip> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ForceReconShip> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, ForceReconShip> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ForceReconShip>
    {

        @Override
        public MetaCategory<? super ForceReconShip> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public Collection<ForceReconShip> items() {
            return (load().values());
        }
    }
}
