    ...
    extends Ship
{
    ...
    private static Map<String, ElectronicAttackShip> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ElectronicAttackShip> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, ElectronicAttackShip> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<ElectronicAttackShip>
    {

        @Override
        public MetaCategory<? super ElectronicAttackShip> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public Collection<ElectronicAttackShip> items() {
            return (load().values());
        }
    }
}
