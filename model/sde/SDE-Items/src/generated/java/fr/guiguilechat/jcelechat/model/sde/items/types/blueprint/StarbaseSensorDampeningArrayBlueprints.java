    ...
    extends Blueprint
{
    ...
    private static Map<String, StarbaseSensorDampeningArrayBlueprints> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StarbaseSensorDampeningArrayBlueprints> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StarbaseSensorDampeningArrayBlueprints> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StarbaseSensorDampeningArrayBlueprints>
    {

        @Override
        public MetaCategory<? super StarbaseSensorDampeningArrayBlueprints> category() {
        ...
        @Override
        public Collection<StarbaseSensorDampeningArrayBlueprints> items() {
            return (load().values());
        }
    }
}
