    ...
    extends Structure
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Refinery> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Refinery>
    {

        @Override
        public MetaCategory<? super Refinery> category() {
        ...
        @Override
        public Collection<Refinery> items() {
            return (load().values());
        }
    }
}
