    ...
    extends StructureModule
{
    ...
    public final static StructureEngineeringRigMBasicSmallShipTE.MetaGroup METAGROUP = new StructureEngineeringRigMBasicSmallShipTE.MetaGroup();
    public final static String RESOURCE_PATH = "SDE/items/structuremodule/StructureEngineeringRigMBasicSmallShipTE.yaml";
    private static Map<String, StructureEngineeringRigMBasicSmallShipTE> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMBasicSmallShipTE> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StructureEngineeringRigMBasicSmallShipTE> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMBasicSmallShipTE>
    {

        @Override
        public MetaCategory<? super StructureEngineeringRigMBasicSmallShipTE> category() {
        ...
        @Override
        public Collection<StructureEngineeringRigMBasicSmallShipTE> items() {
            return (load().values());
        }
    }
}
