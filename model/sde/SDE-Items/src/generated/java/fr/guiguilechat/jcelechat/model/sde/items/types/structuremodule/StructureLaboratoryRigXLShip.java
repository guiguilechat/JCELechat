    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/items/structuremodule/StructureLaboratoryRigXLShip.yaml";
    ...
    public static synchronized LinkedHashMap<String, StructureLaboratoryRigXLShip> load() {
        if (cache == null) {
            try {
                cache = new Yaml().loadAs(new InputStreamReader(StructureLaboratoryRigXLShip.class.getClassLoader().getResourceAsStream((RESOURCE_PATH))), (Container.class)).items;
