...
public class StructureEngineeringRigMBasicLargeShipME
    extends StructureModule
{
    ...
    public final static StructureEngineeringRigMBasicLargeShipME.MetaGroup METAGROUP = new StructureEngineeringRigMBasicLargeShipME.MetaGroup();
    public final static String RESOURCE_PATH = "SDE/items/structuremodule/StructureEngineeringRigMBasicLargeShipME.yaml";
    private static Map<String, StructureEngineeringRigMBasicLargeShipME> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMBasicLargeShipME> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StructureEngineeringRigMBasicLargeShipME> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMBasicLargeShipME>
    {

        @Override
        public MetaCategory<? super StructureEngineeringRigMBasicLargeShipME> category() {
            return StructureModule.METACAT;
        }

        @Override
        public String getName() {
            return "StructureEngineeringRigMBasicLargeShipME";
        }

        @Override
        public Collection<StructureEngineeringRigMBasicLargeShipME> items() {
            return (load().values());
        }
    }
}
