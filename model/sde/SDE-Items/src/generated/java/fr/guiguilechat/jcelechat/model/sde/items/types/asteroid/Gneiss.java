    ...
    extends Asteroid
{
    ...
    private static Map<String, Gneiss> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Gneiss> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, Gneiss> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Gneiss>
    {

        @Override
        public MetaCategory<? super Gneiss> category() {
        ...
        @Override
        public Collection<Gneiss> items() {
            return (load().values());
        }
    }
}
