    ...
    extends StructureModule
{
    ...
    private static Map<String, StructureEngineeringRigMTEResearchAccelerator> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMTEResearchAccelerator> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StructureEngineeringRigMTEResearchAccelerator> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureEngineeringRigMTEResearchAccelerator>
    {

        @Override
        public MetaCategory<? super StructureEngineeringRigMTEResearchAccelerator> category() {
        ...
        @Override
        public Collection<StructureEngineeringRigMTEResearchAccelerator> items() {
            return (load().values());
        }
    }
}
