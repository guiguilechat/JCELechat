    ...
    extends Apparel
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Bottoms> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Bottoms>
    {

        @Override
        public MetaCategory<? super Bottoms> category() {
        ...
        @Override
        public Collection<Bottoms> items() {
            return (load().values());
        }
    }
}
