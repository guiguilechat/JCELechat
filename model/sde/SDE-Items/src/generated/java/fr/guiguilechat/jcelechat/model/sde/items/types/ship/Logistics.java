    ...
    extends Ship
{
    ...
    private static Map<String, Logistics> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Logistics> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, Logistics> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Logistics>
    {

        @Override
        public MetaCategory<? super Logistics> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public Collection<Logistics> items() {
            return (load().values());
        }
    }
}
