    ...
    extends Blueprint
{
    ...
    private static Map<String, RemoteTrackingComputerBlueprint> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<RemoteTrackingComputerBlueprint> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, RemoteTrackingComputerBlueprint> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<RemoteTrackingComputerBlueprint>
    {

        @Override
        public MetaCategory<? super RemoteTrackingComputerBlueprint> category() {
        ...
        @Override
        public Collection<RemoteTrackingComputerBlueprint> items() {
            return (load().values());
        }
    }
}
