    ...
    extends StructureModule
{
    ...
    private static Map<String, StructureCombatRigLMaxTargetsAndSensorBoosting> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureCombatRigLMaxTargetsAndSensorBoosting> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StructureCombatRigLMaxTargetsAndSensorBoosting> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureCombatRigLMaxTargetsAndSensorBoosting>
    {

        @Override
        public MetaCategory<? super StructureCombatRigLMaxTargetsAndSensorBoosting> category() {
        ...
        @Override
        public Collection<StructureCombatRigLMaxTargetsAndSensorBoosting> items() {
            return (load().values());
        }
    }
}
