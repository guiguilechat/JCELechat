    ...
    extends Module
{
    ...
    private static Map<String, AncillaryArmorRepairer> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<AncillaryArmorRepairer> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, AncillaryArmorRepairer> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<AncillaryArmorRepairer>
    {

        @Override
        public MetaCategory<? super AncillaryArmorRepairer> category() {
        ...
        @Override
        public Collection<AncillaryArmorRepairer> items() {
            return (load().values());
        }
    }
}
