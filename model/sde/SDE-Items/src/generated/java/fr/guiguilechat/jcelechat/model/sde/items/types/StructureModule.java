    ...
    extends Item
{
        ...
        implements IMetaCategory<StructureModule>
    {
        ...
        @Override
        public Map<String, StructureModule> load() {
            HashMap<String, StructureModule> ret = new HashMap<>();
