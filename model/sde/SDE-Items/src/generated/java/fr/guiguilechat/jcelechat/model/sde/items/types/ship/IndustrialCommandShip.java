    ...
    extends Ship
{
    ...
    public final static IndustrialCommandShip.MetaGroup METAGROUP = new IndustrialCommandShip.MetaGroup();
    public final static String RESOURCE_PATH = "SDE/items/ship/IndustrialCommandShip.yaml";
    private static Map<String, IndustrialCommandShip> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<IndustrialCommandShip> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, IndustrialCommandShip> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<IndustrialCommandShip>
    {

        @Override
        public MetaCategory<? super IndustrialCommandShip> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public Collection<IndustrialCommandShip> items() {
            return (load().values());
        }
    }
}
