    ...
    extends StructureModule
{
    ...
    private static Map<String, StructureMoonDrillingServiceModule> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureMoonDrillingServiceModule> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, StructureMoonDrillingServiceModule> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<StructureMoonDrillingServiceModule>
    {

        @Override
        public MetaCategory<? super StructureMoonDrillingServiceModule> category() {
        ...
        @Override
        public Collection<StructureMoonDrillingServiceModule> items() {
            return (load().values());
        }
    }
}
