    ...
    extends Implant
{
    ...
    private static Map<String, Booster> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Booster> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, Booster> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Booster>
    {

        @Override
        public MetaCategory<? super Booster> category() {
        ...
        @Override
        public Collection<Booster> items() {
            return (load().values());
        }
    }
}
