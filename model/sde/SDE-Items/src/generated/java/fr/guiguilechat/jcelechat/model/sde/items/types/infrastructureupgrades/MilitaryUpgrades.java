    ...
    extends InfrastructureUpgrades
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<MilitaryUpgrades> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<MilitaryUpgrades>
    {

        @Override
        public MetaCategory<? super MilitaryUpgrades> category() {
        ...
        @Override
        public Collection<MilitaryUpgrades> items() {
            return (load().values());
        }
    }
}
