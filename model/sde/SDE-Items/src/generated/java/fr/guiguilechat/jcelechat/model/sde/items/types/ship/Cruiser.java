    ...
    extends Ship
{
    ...
    private static Map<String, Cruiser> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Cruiser> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, Cruiser> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<Cruiser>
    {

        @Override
        public MetaCategory<? super Cruiser> category() {
            return Ship.METACAT;
        }
        ...
        @Override
        public Collection<Cruiser> items() {
            return (load().values());
        }
    }
}
