    ...
    extends Module
{
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<DroneDamageModules> getGroup() {
        return METAGROUP;
    }
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<DroneDamageModules>
    {

        @Override
        public MetaCategory<? super DroneDamageModules> category() {
        ...
        @Override
        public Collection<DroneDamageModules> items() {
            return (load().values());
        }
    }
}
