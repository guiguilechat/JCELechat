    ...
    extends Blueprint
{
    ...
    private static Map<String, FueledShieldBoosterBlueprint> cache = (null);
    ...
    @Override
    public fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<FueledShieldBoosterBlueprint> getGroup() {
        return METAGROUP;
    }

    public static synchronized Map<String, FueledShieldBoosterBlueprint> load() {
        if (cache == null) {
            try {
    ...
    public static class MetaGroup
        implements fr.guiguilechat.jcelechat.model.sde.items.MetaGroup<FueledShieldBoosterBlueprint>
    {

        @Override
        public MetaCategory<? super FueledShieldBoosterBlueprint> category() {
        ...
        @Override
        public Collection<FueledShieldBoosterBlueprint> items() {
            return (load().values());
        }
    }
}
