...
import fr.guiguilechat.jcelechat.model.sde.attributes.ShipRoleBonusGeneralMiningHoldCapacity;
    ...
    extends Ship
{
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int shiprolebonusgeneralminingholdcapacity;
    /**
