    ...
    extends Ship
{
        ...
        implements IMetaGroup<LogisticsFrigate>
    {
        ...
        @Override
        public synchronized Map<String, LogisticsFrigate> load() {
            if (cache == null) {
        ...
        private static class Container {
            public LinkedHashMap<String, LogisticsFrigate> types;
        }
    }
}
