    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {UpgradeCost.INSTANCE, DurationBonus.INSTANCE, Radius.INSTANCE, Mass.INSTANCE, TechLevel.INSTANCE, RangeSkillBonus.INSTANCE, Capacity.INSTANCE, AccessDifficultyBonusModifier.INSTANCE, Hp.INSTANCE, RigSize.INSTANCE, CloakingTargetingDelayBonus.INSTANCE, ScanStrengthBonus.INSTANCE, Drawback.INSTANCE, ScanspeedBonus.INSTANCE, MaxTargetRangeBonus.INSTANCE, ScanResolutionBonus.INSTANCE, MetaLevel.INSTANCE, VirusCoherenceBonus.INSTANCE, ScanSkillEwStrengthBonus.INSTANCE, CapNeedBonus.INSTANCE })));
