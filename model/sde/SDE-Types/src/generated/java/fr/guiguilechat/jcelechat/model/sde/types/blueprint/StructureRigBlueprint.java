    ...
    extends Blueprint
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {Radius.INSTANCE, Capacity.INSTANCE, TechLevel.INSTANCE, StructureItemVisualFlag.INSTANCE })));
        ...
        implements IMetaGroup<StructureRigBlueprint>
    {
        ...
        private Map<Integer, StructureRigBlueprint> cache = (null);
        ...
        @Override
        public synchronized Map<Integer, StructureRigBlueprint> load() {
            if (cache == null) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, StructureRigBlueprint> types;
        }
    }
}
