    ...
    extends Celestial
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {Radius.INSTANCE, Capacity.INSTANCE, SignatureRadius.INSTANCE, Hp.INSTANCE, StructureUniformity.INSTANCE })));
        ...
        implements IMetaGroup<CargoContainer>
    {
        ...
        private Map<Integer, CargoContainer> cache = (null);
        ...
        @Override
        public synchronized Map<Integer, CargoContainer> load() {
            if (cache == null) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, CargoContainer> types;
        }
    }
}
