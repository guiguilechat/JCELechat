    ...
    extends Entity
{
        ...
        implements IMetaGroup<MissionAmarrEmpireDestroyer>
    {
        ...
        private Map<Integer, MissionAmarrEmpireDestroyer> cache = (null);
        ...
        @Override
        public synchronized Map<Integer, MissionAmarrEmpireDestroyer> load() {
            if (cache == null) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, MissionAmarrEmpireDestroyer> types;
        }
    }
}
