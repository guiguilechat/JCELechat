...
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupArmorResistanceActivationChance;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupArmorResistanceBonus;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupArmorResistanceDuration;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupPropJamActivationChance;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupPropJamBonus;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupPropJamDuration;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupRespawnChance;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupShieldResistanceActivationChance;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupShieldResistanceBonus;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupShieldResistanceDuration;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupSpeedActivationChance;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupSpeedBonus;
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityGroupSpeedDuration;
    ...
    extends Entity
{
    ...
    @Stackable(true)
    @DefaultIntValue(1)
    public int entitygrouparmorresistanceactivationchance;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int entitygrouparmorresistancebonus;
    /**
    ...
    public int entitygrouparmorresistanceduration;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(1)
    public int entitygrouppropjamactivationchance;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int entitygrouppropjambonus;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(10000)
    public int entitygrouppropjamduration;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(1)
    public int entitygroupshieldresistanceactivationchance;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int entitygroupshieldresistancebonus;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(10000)
    public int entitygroupshieldresistanceduration;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(1)
    public int entitygroupspeedactivationchance;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int entitygroupspeedbonus;
    /**
     * Duration of NPCGroupArmorAssist effect.
     */
    @HighIsGood(true)
    @Stackable(true)
    @DefaultIntValue(10000)
    public int entitygroupspeedduration;
    /**
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {ModifyTargetSpeedChance.INSTANCE, ModifyTargetSpeedDuration.INSTANCE, ModifyTargetSpeedRange.INSTANCE, ShieldCapacity.INSTANCE, ShieldCharge.INSTANCE, Hp.INSTANCE, ArmorHP.INSTANCE, ArmorEmDamageResonance.INSTANCE, ArmorExplosiveDamageResonance.INSTANCE, ArmorUniformity.INSTANCE, ArmorKineticDamageResonance.INSTANCE, StructureUniformity.INSTANCE, ArmorThermalDamageResonance.INSTANCE, ShieldEmDamageResonance.INSTANCE, ShieldExplosiveDamageResonance.INSTANCE, ShieldKineticDamageResonance.INSTANCE, ShieldThermalDamageResonance.INSTANCE, Charge.INSTANCE, SpeedFactor.INSTANCE, EntityBracketColour.INSTANCE, MaxVelocity.INSTANCE, Capacity.INSTANCE, SignatureRadius.INSTANCE, SignatureRadiusBonus.INSTANCE, EntityFactionLoss.INSTANCE, Speed.INSTANCE, EntitySecurityMaxGain.INSTANCE, ScanResolution.INSTANCE, MaxRange.INSTANCE, RechargeRate.INSTANCE, DamageMultiplier.INSTANCE, EntityChaseMaxDelay.INSTANCE, EntityChaseMaxDelayChance.INSTANCE, EntityChaseMaxDuration.INSTANCE, EntityChaseMaxDurationChance.INSTANCE, DisallowAssistance.INSTANCE, MissileEntityAoeCloudSizeMultiplier.INSTANCE, MissileEntityAoeVelocityMultiplier.INSTANCE, WarpScrambleRange.INSTANCE, WarpScrambleStrength.INSTANCE, OptimalSigRadius.INSTANCE, AIShouldUseTargetSwitching.INSTANCE, AIShouldUseSecondaryTarget.INSTANCE, AIShouldUseSignatureRadius.INSTANCE, EmDamage.INSTANCE, AIChanceToNotTargetSwitch.INSTANCE, AIShouldUseEffectMultiplier.INSTANCE, ThermalDamage.INSTANCE, AIPreferredSignatureRadius.INSTANCE, EntityShieldBoostDuration.INSTANCE, EntityShieldBoostAmount.INSTANCE, EntityGroupRespawnChance.INSTANCE, MissileEntityVelocityMultiplier.INSTANCE, MissileEntityFlightTimeMultiplier.INSTANCE, EntityGroupShieldResistanceBonus.INSTANCE, EntityGroupShieldResistanceDuration.INSTANCE, EntityGroupShieldResistanceActivationChance.INSTANCE, EntityGroupSpeedBonus.INSTANCE, EntityGroupPropJamBonus.INSTANCE, EntityGroupArmorResistanceBonus.INSTANCE, EntityGroupSpeedDuration.INSTANCE, EntityGroupSpeedActivationChance.INSTANCE, EntityGroupPropJamDuration.INSTANCE, EntityGroupPropJamActivationChance.INSTANCE, EntityGroupArmorResistanceDuration.INSTANCE, EntityGroupArmorResistanceActivationChance.INSTANCE, EntityChaseMaxDistance.INSTANCE, Falloff.INSTANCE, TrackingSpeed.INSTANCE, EntityFlyRange.INSTANCE, EntityTargetJam.INSTANCE, ECMDuration.INSTANCE, Radius.INSTANCE, ECMEntityChance.INSTANCE, ECMRangeOptimal.INSTANCE, NpcRemoteShieldBoostDuration.INSTANCE, NpcRemoteShieldBoostChance.INSTANCE, NpcRemoteShieldBoostAmount.INSTANCE, NpcRemoteShieldBoostThreshold.INSTANCE, NpcAssistanceRange.INSTANCE, ECMRangeFalloff.INSTANCE, MaxLockedTargets.INSTANCE, MaxAttackTargets.INSTANCE, EntityEquipmentMin.INSTANCE, EntityEquipmentMax.INSTANCE, ScanRadarStrength.INSTANCE, ScanLadarStrength.INSTANCE, EntityReactionFactor.INSTANCE, ScanMagnetometricStrength.INSTANCE, ScanGravimetricStrength.INSTANCE, MissileDamageMultiplier.INSTANCE, PropulsionGraphicID.INSTANCE, EntityAttackDelayMin.INSTANCE, EntityAttackDelayMax.INSTANCE, NpcRemoteShieldBoostMaxTargets.INSTANCE, ShieldRechargeRate.INSTANCE, CapacitorCapacity.INSTANCE, ShieldUniformity.INSTANCE, EntityOverviewShipGroupId.INSTANCE, ScanGravimetricStrengthBonus.INSTANCE, EntityShieldBoostDelayChanceMedium.INSTANCE, ScanLadarStrengthBonus.INSTANCE, ScanMagnetometricStrengthBonus.INSTANCE, ScanRadarStrengthBonus.INSTANCE, GfxTurretID.INSTANCE, GfxBoosterID.INSTANCE, EntityAttackRange.INSTANCE, EntityWarpScrambleChance.INSTANCE, WarpScrambleDuration.INSTANCE, MissileLaunchDuration.INSTANCE, EntityLootCountMin.INSTANCE, EntityMissileTypeID.INSTANCE, EntityCruiseSpeed.INSTANCE, EntitySecurityStatusKillBonus.INSTANCE })));
    ...
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/IncursionSanshaSNationCruiser.yaml";
        private Map<Integer, IncursionSanshaSNationCruiser> cache = (null);
        ...
        @Override
        public synchronized Map<Integer, IncursionSanshaSNationCruiser> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(IncursionSanshaSNationCruiser.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, IncursionSanshaSNationCruiser> types;
        }
    }
}
