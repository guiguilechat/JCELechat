...
public class GasHarvesterBlueprint
    extends Blueprint
{
    /**
    ...
    public static final GasHarvesterBlueprint.MetaGroup METAGROUP = new GasHarvesterBlueprint.MetaGroup();
    ...
    @Override
    public IMetaGroup<GasHarvesterBlueprint> getGroup() {
        return METAGROUP;
    }
