    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {UpgradeCost.INSTANCE, Drawback.INSTANCE, MiningAmountBonus.INSTANCE, Radius.INSTANCE, Mass.INSTANCE, TechLevel.INSTANCE, AccessDifficultyBonus.INSTANCE, Capacity.INSTANCE, MetaLevel.INSTANCE, Hp.INSTANCE, RigSize.INSTANCE, IceHarvestCycleBonus.INSTANCE })));
