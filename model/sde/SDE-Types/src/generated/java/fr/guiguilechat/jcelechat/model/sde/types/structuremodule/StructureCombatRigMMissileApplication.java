...
public class StructureCombatRigMMissileApplication
    extends StructureModule
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {UpgradeCost.INSTANCE, Radius.INSTANCE, StructureRigMissileExploVeloBonus.INSTANCE, Capacity.INSTANCE, TechLevel.INSTANCE, MaxGroupFitted.INSTANCE, Hp.INSTANCE, RigSize.INSTANCE, CanFitShipGroup01 .INSTANCE, HiSecModifier.INSTANCE, CanFitShipGroup02 .INSTANCE, CanFitShipGroup03 .INSTANCE, LowSecModifier.INSTANCE, RequiredSkill1Level.INSTANCE, NullSecModifier.INSTANCE, SecurityModifier.INSTANCE, RequiredSkill1 .INSTANCE, StructureItemVisualFlag.INSTANCE })));
    ...
    @Override
    public IMetaGroup<StructureCombatRigMMissileApplication> getGroup() {
        return METAGROUP;
    }
    ...
    {
        public static final String RESOURCE_PATH = "SDE/types/structuremodule/StructureCombatRigMMissileApplication.yaml";
        private Map<Integer, StructureCombatRigMMissileApplication> cache = (null);

        @Override
        public IMetaCategory<? super StructureCombatRigMMissileApplication> category() {
        ...
        public String getName() {
            return "StructureCombatRigMMissileApplication";
        }

        @Override
        public synchronized Map<Integer, StructureCombatRigMMissileApplication> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(StructureCombatRigMMissileApplication.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, StructureCombatRigMMissileApplication> types;
        }
    }
}
