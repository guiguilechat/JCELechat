    ...
    extends StructureModule
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {UpgradeCost.INSTANCE, Radius.INSTANCE, Mass.INSTANCE, TechLevel.INSTANCE, Capacity.INSTANCE, MaxGroupFitted.INSTANCE, Hp.INSTANCE, RigSize.INSTANCE, RefiningYieldMultiplier.INSTANCE, CanFitShipGroup01 .INSTANCE, HiSecModifier.INSTANCE, CanFitShipGroup02 .INSTANCE, CanFitShipGroup03 .INSTANCE, LowSecModifier.INSTANCE, RequiredSkill1Level.INSTANCE, NullSecModifier.INSTANCE, SecurityModifier.INSTANCE, RequiredSkill1 .INSTANCE, StructureItemVisualFlag.INSTANCE })));
    public static final StructureResourceRigMIceReprocessing.MetaGroup METAGROUP = new StructureResourceRigMIceReprocessing.MetaGroup();
    ...
    @Override
    public IMetaGroup<StructureResourceRigMIceReprocessing> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<StructureResourceRigMIceReprocessing>
    {
        public static final String RESOURCE_PATH = "SDE/types/structuremodule/StructureResourceRigMIceReprocessing.yaml";
        private Map<String, StructureResourceRigMIceReprocessing> cache = (null);

        @Override
        public IMetaCategory<? super StructureResourceRigMIceReprocessing> category() {
        ...
        public String getName() {
            return "StructureResourceRigMIceReprocessing";
        }

        @Override
        public synchronized Map<String, StructureResourceRigMIceReprocessing> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(StructureResourceRigMIceReprocessing.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<String, StructureResourceRigMIceReprocessing> types;
        }
    }
}
