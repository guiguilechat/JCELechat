...
public class Ecertificates {
	...
	public static final JacksonYamlLoader<LinkedHashMap<Integer, Ecertificates>> LOADER_JACKSON = new JacksonYamlLoader<>(
			SDE_FILE_YAML);

	public static final SnakeYamlLHMLoader<Integer, Ecertificates> LOADER_SNAKEYAML = new SnakeYamlLHMLoader<>(
			SDE_FILE_YAML) {
	...
	public static final JacksonYamlLoader<LinkedHashMap<Integer, Ecertificates>> LOADER = LOADER_SNAKEYAML;
