...
public class Eancestries {
	...
	public static final OldJacksonYamlLoader<LinkedHashMap<Integer, Eancestries>> LOADER_JACKSON = new OldJacksonYamlLoader<>(
			SDE_FILE);

	public static final OldSnakeYamlLHMLoader<Integer, Eancestries> LOADER_SNAKEYAML = new OldSnakeYamlLHMLoader<>(SDE_FILE) {
	...
	public static final OldJacksonYamlLoader<LinkedHashMap<Integer, Eancestries>> LOADER = LOADER_SNAKEYAML;
