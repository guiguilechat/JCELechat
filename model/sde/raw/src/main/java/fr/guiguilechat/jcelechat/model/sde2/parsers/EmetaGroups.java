...
public class EmetaGroups {
	...
	public static final JacksonYamlLoader<LinkedHashMap<Integer, EmetaGroups>> LOADER_JACKSON = new JacksonYamlLoader<>(
			SDE_FILE_YAML);

	public static final SnakeYamlLHMLoader<Integer, EmetaGroups> LOADER_SNAKEYAML = new SnakeYamlLHMLoader<>(
			SDE_FILE_YAML) {
	...
	public static final JacksonYamlLoader<LinkedHashMap<Integer, EmetaGroups>> LOADER = LOADER_SNAKEYAML;
