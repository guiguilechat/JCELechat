...
public class AsteroidGuristasOfficerFrigate
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<AsteroidGuristasOfficerFrigate> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<AsteroidGuristasOfficerFrigate>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/AsteroidGuristasOfficerFrigate.yaml";
        private Map<Integer, AsteroidGuristasOfficerFrigate> cache = (null);

        @Override
        public IMetaCategory<? super AsteroidGuristasOfficerFrigate> category() {
        ...
        public String getName() {
            return "AsteroidGuristasOfficerFrigate";
        }

        @Override
        public synchronized Map<Integer, AsteroidGuristasOfficerFrigate> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AsteroidGuristasOfficerFrigate.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AsteroidGuristasOfficerFrigate> types;
        }
    }
}
