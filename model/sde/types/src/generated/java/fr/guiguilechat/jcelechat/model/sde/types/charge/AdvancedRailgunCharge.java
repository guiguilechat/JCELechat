    ...
    extends Charge
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {ChargeSize.INSTANCE, TechLevel.INSTANCE, LauncherGroup.INSTANCE, SignatureRadiusBonus.INSTANCE, EntityFlyRangeMultiplier.INSTANCE, SpeedMultiplier.INSTANCE, EmDamage.INSTANCE, ShieldCapacityMultiplier.INSTANCE, MaxVelocityModifier.INSTANCE, ExplosiveDamage.INSTANCE, TrackingSpeedMultiplier.INSTANCE, KineticDamage.INSTANCE, RequiredSkill1Level.INSTANCE, ThermalDamage.INSTANCE, RequiredSkill1 .INSTANCE, WeaponRangeMultiplier.INSTANCE, MetaLevelOld.INSTANCE, MainColor.INSTANCE, CapNeedBonus.INSTANCE })));
