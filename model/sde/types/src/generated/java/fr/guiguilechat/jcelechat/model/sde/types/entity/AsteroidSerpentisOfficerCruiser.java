...
public class AsteroidSerpentisOfficerCruiser
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<AsteroidSerpentisOfficerCruiser> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<AsteroidSerpentisOfficerCruiser>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/AsteroidSerpentisOfficerCruiser.yaml";
        private Map<Integer, AsteroidSerpentisOfficerCruiser> cache = (null);

        @Override
        public IMetaCategory<? super AsteroidSerpentisOfficerCruiser> category() {
        ...
        public String getName() {
            return "AsteroidSerpentisOfficerCruiser";
        }

        @Override
        public synchronized Map<Integer, AsteroidSerpentisOfficerCruiser> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AsteroidSerpentisOfficerCruiser.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AsteroidSerpentisOfficerCruiser> types;
        }
    }
}
