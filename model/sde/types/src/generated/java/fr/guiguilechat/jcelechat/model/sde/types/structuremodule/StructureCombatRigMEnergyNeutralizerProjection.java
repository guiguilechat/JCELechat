    ...
    extends StructureModule
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {UpgradeCost.INSTANCE, TechLevel.INSTANCE, MaxGroupFitted.INSTANCE, StructureRigEwarOptimalBonus.INSTANCE, Hp.INSTANCE, StructureRigEwarFalloffBonus.INSTANCE, RigSize.INSTANCE, CanFitShipGroup01 .INSTANCE, CanFitShipGroup02 .INSTANCE, HiSecModifier.INSTANCE, CanFitShipGroup03 .INSTANCE, LowSecModifier.INSTANCE, RequiredSkill1Level.INSTANCE, NullSecModifier.INSTANCE, RequiredSkill1 .INSTANCE, SecurityModifier.INSTANCE, StructureItemVisualFlag.INSTANCE })));
