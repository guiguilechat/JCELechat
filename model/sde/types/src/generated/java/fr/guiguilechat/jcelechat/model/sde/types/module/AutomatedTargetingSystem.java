    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {Cpu.INSTANCE, RequiredSkill1Level.INSTANCE, CapacitorNeed.INSTANCE, RequiredSkill1 .INSTANCE, TechLevel.INSTANCE, Duration.INSTANCE, Hp.INSTANCE, MetaLevelOld.INSTANCE, MaxLockedTargetsBonus.INSTANCE, Power.INSTANCE, TargetHostileRange.INSTANCE })));
