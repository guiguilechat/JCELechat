    ...
    extends Blueprint
{
        ...
        implements IMetaGroup<MiningLaserBlueprint>
    {
        ...
        private Map<Integer, MiningLaserBlueprint> cache = (null);
        ...
        @Override
        public synchronized Map<Integer, MiningLaserBlueprint> load() {
            if (cache == null) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, MiningLaserBlueprint> types;
        }
    }
}
