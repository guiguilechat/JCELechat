    ...
    extends InfrastructureUpgrades
{
    ...
    @Override
    public IMetaGroup<InfrastructureHubMilitaryUpgrades> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<InfrastructureHubMilitaryUpgrades>
    {
        public static final String RESOURCE_PATH = "SDE/types/infrastructureupgrades/InfrastructureHubMilitaryUpgrades.yaml";
        private Map<Integer, InfrastructureHubMilitaryUpgrades> cache = (null);

        @Override
        public IMetaCategory<? super InfrastructureHubMilitaryUpgrades> category() {
        ...
        public String getName() {
            return "InfrastructureHubMilitaryUpgrades";
        }

        @Override
        public synchronized Map<Integer, InfrastructureHubMilitaryUpgrades> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(InfrastructureHubMilitaryUpgrades.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, InfrastructureHubMilitaryUpgrades> types;
        }
    }
}
