    ...
    extends Celestial
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {SignatureRadius.INSTANCE, Hp.INSTANCE, StructureUniformity.INSTANCE })));
