    ...
    extends Entity
{
    ...
    @Override
    public IMetaGroup<IrregularMiningBarge> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<IrregularMiningBarge>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/IrregularMiningBarge.yaml";
        private Map<Integer, IrregularMiningBarge> cache = (null);

        @Override
        public IMetaCategory<? super IrregularMiningBarge> category() {
        ...
        public String getName() {
            return "IrregularMiningBarge";
        }

        @Override
        public synchronized Map<Integer, IrregularMiningBarge> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(IrregularMiningBarge.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, IrregularMiningBarge> types;
        }
    }
}
