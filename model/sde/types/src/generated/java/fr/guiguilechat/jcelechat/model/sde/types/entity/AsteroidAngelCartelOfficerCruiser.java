...
import fr.guiguilechat.jcelechat.model.sde.attributes.EntityTargetPaintMaxRange;
...
public class AsteroidAngelCartelOfficerCruiser
    extends Entity
{
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int entitytargetpaintmaxrange;
    /**
    ...
    @Override
    public IMetaGroup<AsteroidAngelCartelOfficerCruiser> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<AsteroidAngelCartelOfficerCruiser>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/AsteroidAngelCartelOfficerCruiser.yaml";
        private Map<Integer, AsteroidAngelCartelOfficerCruiser> cache = (null);

        @Override
        public IMetaCategory<? super AsteroidAngelCartelOfficerCruiser> category() {
        ...
        public String getName() {
            return "AsteroidAngelCartelOfficerCruiser";
        }

        @Override
        public synchronized Map<Integer, AsteroidAngelCartelOfficerCruiser> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AsteroidAngelCartelOfficerCruiser.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AsteroidAngelCartelOfficerCruiser> types;
        }
    }
}
