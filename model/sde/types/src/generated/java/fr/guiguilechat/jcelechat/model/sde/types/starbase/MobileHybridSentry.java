...
public class MobileHybridSentry
    extends Starbase
{
    /**
     * 
    ...
    @Override
    public IMetaGroup<MobileHybridSentry> getGroup() {
        return METAGROUP;
    }
