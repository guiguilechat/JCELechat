...
public class AsteroidAngelCartelOfficerFrigate
    extends Entity
{
    /**
    ...
    public static final AsteroidAngelCartelOfficerFrigate.MetaGroup METAGROUP = new AsteroidAngelCartelOfficerFrigate.MetaGroup();
    ...
    @Override
    public IMetaGroup<AsteroidAngelCartelOfficerFrigate> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<AsteroidAngelCartelOfficerFrigate>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/AsteroidAngelCartelOfficerFrigate.yaml";
        private Map<Integer, AsteroidAngelCartelOfficerFrigate> cache = (null);

        @Override
        public IMetaCategory<? super AsteroidAngelCartelOfficerFrigate> category() {
        ...
        public String getName() {
            return "AsteroidAngelCartelOfficerFrigate";
        }

        @Override
        public synchronized Map<Integer, AsteroidAngelCartelOfficerFrigate> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AsteroidAngelCartelOfficerFrigate.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AsteroidAngelCartelOfficerFrigate> types;
        }
    }
}
