    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {MaxScanDeviationModifierModule.INSTANCE, Cpu.INSTANCE, ScanStrengthBonusModule.INSTANCE, RequiredSkill1Level.INSTANCE, RequiredSkill1 .INSTANCE, TechLevel.INSTANCE, Hp.INSTANCE, MetaLevelOld.INSTANCE, Power.INSTANCE })));
        ...
        implements IMetaGroup<ScanningUpgrade>
    {
        ...
        private Map<Integer, ScanningUpgrade> cache = (null);
        ...
        @Override
        public synchronized Map<Integer, ScanningUpgrade> load() {
            if (cache == null) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, ScanningUpgrade> types;
        }
    }
}
