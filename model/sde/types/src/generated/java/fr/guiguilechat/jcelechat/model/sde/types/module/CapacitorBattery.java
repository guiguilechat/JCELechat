    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {Cpu.INSTANCE, Radius.INSTANCE, CapacitorBonus.INSTANCE, RequiredSkill1Level.INSTANCE, RequiredSkill1 .INSTANCE, TechLevel.INSTANCE, Capacity.INSTANCE, Hp.INSTANCE, MetaLevelOld.INSTANCE, EnergyWarfareResistanceBonus.INSTANCE, MetaGroupID.INSTANCE, Power.INSTANCE })));
        ...
        implements IMetaGroup<CapacitorBattery>
    {
        ...
        private Map<Integer, CapacitorBattery> cache = (null);
        ...
        @Override
        public synchronized Map<Integer, CapacitorBattery> load() {
            if (cache == null) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, CapacitorBattery> types;
        }
    }
}
