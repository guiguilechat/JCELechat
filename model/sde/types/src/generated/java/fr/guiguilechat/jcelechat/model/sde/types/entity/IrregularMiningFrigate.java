    ...
    extends Entity
{
    ...
    @Override
    public IMetaGroup<IrregularMiningFrigate> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<IrregularMiningFrigate>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/IrregularMiningFrigate.yaml";
        private Map<Integer, IrregularMiningFrigate> cache = (null);

        @Override
        public IMetaCategory<? super IrregularMiningFrigate> category() {
        ...
        public String getName() {
            return "IrregularMiningFrigate";
        }

        @Override
        public synchronized Map<Integer, IrregularMiningFrigate> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(IrregularMiningFrigate.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, IrregularMiningFrigate> types;
        }
    }
}
