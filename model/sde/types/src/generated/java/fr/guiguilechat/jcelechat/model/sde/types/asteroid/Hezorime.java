    ...
    extends Asteroid
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {Radius.INSTANCE, StasisWebifierResistance.INSTANCE, IgnoreMiningWaste.INSTANCE, RequiredSkill1Level.INSTANCE, ReprocessingSkillType.INSTANCE, RequiredSkill1 .INSTANCE, Capacity.INSTANCE, OreBasicType.INSTANCE, AsteroidMetaLevel.INSTANCE, AsteroidRadiusGrowthFactor.INSTANCE, AsteroidRadiusUnitSize.INSTANCE })));
    public static final Hezorime.MetaGroup METAGROUP = new Hezorime.MetaGroup();
    ...
    @Override
    public IMetaGroup<Hezorime> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<Hezorime>
    {
        public static final String RESOURCE_PATH = "SDE/types/asteroid/Hezorime.yaml";
        private Map<Integer, Hezorime> cache = (null);

        @Override
        public IMetaCategory<? super Hezorime> category() {
        ...
        @Override
        public synchronized Map<Integer, Hezorime> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(Hezorime.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, Hezorime> types;
        }
    }
}
