...
public class AsteroidBloodRaidersOfficerCruiser
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<AsteroidBloodRaidersOfficerCruiser> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<AsteroidBloodRaidersOfficerCruiser>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/AsteroidBloodRaidersOfficerCruiser.yaml";
        private Map<Integer, AsteroidBloodRaidersOfficerCruiser> cache = (null);

        @Override
        public IMetaCategory<? super AsteroidBloodRaidersOfficerCruiser> category() {
        ...
        public String getName() {
            return "AsteroidBloodRaidersOfficerCruiser";
        }

        @Override
        public synchronized Map<Integer, AsteroidBloodRaidersOfficerCruiser> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AsteroidBloodRaidersOfficerCruiser.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AsteroidBloodRaidersOfficerCruiser> types;
        }
    }
}
