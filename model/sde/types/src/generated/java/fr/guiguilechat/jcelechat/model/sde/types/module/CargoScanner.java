    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {Cpu.INSTANCE, RequiredSkill1Level.INSTANCE, CapacitorNeed.INSTANCE, RequiredSkill1 .INSTANCE, DisallowRepeatingActivation.INSTANCE, TechLevel.INSTANCE, Duration.INSTANCE, Hp.INSTANCE, MetaLevelOld.INSTANCE, Power.INSTANCE, CargoScanRange.INSTANCE })));
