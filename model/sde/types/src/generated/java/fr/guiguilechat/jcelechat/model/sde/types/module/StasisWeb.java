    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {CapacitorNeed.INSTANCE, OverloadRangeBonus.INSTANCE, TechLevel.INSTANCE, Duration.INSTANCE, Hp.INSTANCE, Cpu.INSTANCE, SpeedFactor.INSTANCE, RequiredSkill1Level.INSTANCE, MaxRange.INSTANCE, RequiredSkill1 .INSTANCE, MetaLevelOld.INSTANCE, RemoteResistanceID.INSTANCE, HeatDamage.INSTANCE, HeatAbsorbtionRateModifier.INSTANCE, RequiredThermoDynamicsSkill.INSTANCE, MetaGroupID.INSTANCE, FalloffEffectiveness.INSTANCE, Power.INSTANCE, Falloff.INSTANCE })));
