    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {DamageMultiplier.INSTANCE, UpgradeCost.INSTANCE, TechLevel.INSTANCE, Hp.INSTANCE, RigSize.INSTANCE, SpeedMultiplier.INSTANCE, Drawback.INSTANCE, TrackingSpeedMultiplier.INSTANCE, CpuNeedBonus.INSTANCE, MetaLevelOld.INSTANCE, CapNeedBonus.INSTANCE, FalloffBonus.INSTANCE, MaxRangeBonus.INSTANCE, TrackingSpeedBonus.INSTANCE })));
