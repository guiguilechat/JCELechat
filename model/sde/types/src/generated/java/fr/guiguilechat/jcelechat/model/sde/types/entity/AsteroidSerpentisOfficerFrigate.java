...
public class AsteroidSerpentisOfficerFrigate
    extends Entity
{
    /**
    ...
    @Override
    public IMetaGroup<AsteroidSerpentisOfficerFrigate> getGroup() {
        return METAGROUP;
    }

    public static class MetaGroup
        implements IMetaGroup<AsteroidSerpentisOfficerFrigate>
    {
        public static final String RESOURCE_PATH = "SDE/types/entity/AsteroidSerpentisOfficerFrigate.yaml";
        private Map<Integer, AsteroidSerpentisOfficerFrigate> cache = (null);

        @Override
        public IMetaCategory<? super AsteroidSerpentisOfficerFrigate> category() {
        ...
        public String getName() {
            return "AsteroidSerpentisOfficerFrigate";
        }

        @Override
        public synchronized Map<Integer, AsteroidSerpentisOfficerFrigate> load() {
            if (cache == null) {
                try(final InputStreamReader reader = new InputStreamReader(AsteroidSerpentisOfficerFrigate.MetaGroup.class.getClassLoader().getResourceAsStream((RESOURCE_PATH)))) {
        ...
        private static class Container {
            public LinkedHashMap<Integer, AsteroidSerpentisOfficerFrigate> types;
        }
    }
}
