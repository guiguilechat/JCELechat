    ...
    extends Module
{
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {Cpu.INSTANCE, Speed.INSTANCE, ReloadTime.INSTANCE, TechLevel.INSTANCE, ChargeRate.INSTANCE, TypeColorScheme.INSTANCE, Hp.INSTANCE, MetaLevelOld.INSTANCE, ChargeGroup1 .INSTANCE, Power.INSTANCE, Slots.INSTANCE })));
