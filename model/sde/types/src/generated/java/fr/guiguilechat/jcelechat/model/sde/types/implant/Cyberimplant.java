...
import fr.guiguilechat.jcelechat.model.sde.attributes.ImplantSetHackingVirusCoherenceModifier;
import fr.guiguilechat.jcelechat.model.sde.attributes.ImplantSetHackingVirusCoherenceOmegaSetBonus;
import fr.guiguilechat.jcelechat.model.sde.attributes.ImplantSetHackingVirusCoherenceOmegaSetBonusFAKE;
...
import fr.guiguilechat.jcelechat.model.sde.attributes.RemoteRepDurationCapBonus;
    ...
    extends Implant
{
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int implantsethackingviruscoherencemodifier;
    @HighIsGood(true)
    @Stackable(true)
    @DefaultRealValue(1.0)
    public double implantsethackingviruscoherenceomegasetbonus;
    /**
    ...
    @Stackable(true)
    @DefaultIntValue(0)
    public int implantsethackingviruscoherenceomegasetbonusfake;
    /**
     * 
     */
    @HighIsGood(true)
    ...
    @Stackable(true)
    @DefaultRealValue(0.0)
    public double remoterepdurationcapbonus;
    /**
    ...
    public static final Set<Attribute> ATTRIBUTES = Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(new Attribute[] {ImplantSetThukker.INSTANCE, ScanGravimetricStrengthPercent.INSTANCE, ImplantSetSisters.INSTANCE, ScanLadarStrengthPercent.INSTANCE, ScanMagnetometricStrengthPercent.INSTANCE, ScanRadarStrengthPercent.INSTANCE, DamageMultiplierBonusMaxModifier.INSTANCE, DamageMultiplierBonusPerCycleModifier.INSTANCE, SetBonusMimesis.INSTANCE, ImplantSetSyndicate.INSTANCE, ImplantSetORE.INSTANCE, ImplantSetWarpSpeed.INSTANCE, ImplantSetMordus.INSTANCE, ImplantSetImperialNavy.INSTANCE, ImplantSetCaldariNavy.INSTANCE, ImplantSetFederationNavy.INSTANCE, ImplantSetRepublicFleet.INSTANCE, RequiredSkill1Level.INSTANCE, RequiredSkill2Level.INSTANCE, AgilityBonus.INSTANCE, DisallowOffensiveModifierBonus.INSTANCE, ArmorRepairBonus.INSTANCE, ScanRadarStrengthModifier.INSTANCE, ScanLadarStrengthModifier.INSTANCE, ImplantSetBloodraider.INSTANCE, ScanGravimetricStrengthModifier.INSTANCE, ScanMagnetometricStrengthModifier.INSTANCE, ImplantSetLGImperialNavy.INSTANCE, ImplantSetSerpentis.INSTANCE, ImplantSetLGFederationNavy.INSTANCE, ImplantSetSerpentis2 .INSTANCE, ImplantSetRapture.INSTANCE, ImplantSetLGCaldariNavy.INSTANCE, ShieldBoostMultiplier.INSTANCE, ImplantSetLGRepublicFleet.INSTANCE, TechLevel.INSTANCE, ImplantSetHackingVirusCoherenceOmegaSetBonus.INSTANCE, RangeSkillBonus.INSTANCE, RepairBonus.INSTANCE, ImplantSetHackingVirusCoherenceModifier.INSTANCE, ImplantSetHackingVirusCoherenceOmegaSetBonusFAKE.INSTANCE, CpuOutputBonus2 .INSTANCE, SignatureRadiusBonus.INSTANCE, CharismaBonus.INSTANCE, IntelligenceBonus.INSTANCE, MemoryBonus.INSTANCE, PerceptionBonus.INSTANCE, WillpowerBonus.INSTANCE, MaxTargetRangeBonus.INSTANCE, RequiredSkill1 .INSTANCE, RequiredSkill2 .INSTANCE, PowerEngineeringOutputBonus.INSTANCE, CapRechargeBonus.INSTANCE, VelocityBonus.INSTANCE, DoesNotEmergencyWarp.INSTANCE, SmugglingChanceBonus.INSTANCE, DurationBonus.INSTANCE, ImplantSetGuristas.INSTANCE, ShieldHpBonus.INSTANCE, ImplantSetNirvana.INSTANCE, Implantness.INSTANCE, ScanStrengthBonus.INSTANCE, ArmorHpBonus.INSTANCE, ImplantSetSavior.INSTANCE, RemoteRepDurationCapBonus.INSTANCE, ShieldCapacityBonus.INSTANCE, ImplantSetHydra.INSTANCE, HydraDroneTrackingBonus.INSTANCE, HydraDroneRangeBonus.INSTANCE, HydraMissileFlightTimeBonus.INSTANCE, HydraMissileExplosionVelocityBonus.INSTANCE, ImplantSetHalo.INSTANCE, MaxRangeBonus.INSTANCE, ImplantSetAmulet.INSTANCE, PassiveEmDamageResistanceBonus.INSTANCE, Nondestructible.INSTANCE, PassiveExplosiveDamageResistanceBonus.INSTANCE, PassiveKineticDamageResistanceBonus.INSTANCE, PassiveThermicDamageResistanceBonus.INSTANCE, BoosterAttributeModifier.INSTANCE, JumpDriveRangeBonus.INSTANCE, WarpSBonus.INSTANCE, TrackingSpeedMultiplier.INSTANCE, MetaLevelOld.INSTANCE, FollowsJumpClones.INSTANCE })));
