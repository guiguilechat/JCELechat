...
public class HeatSinkBlueprint
    extends Blueprint
{
    ...
    public final static String RESOURCE_PATH = "SDE/blueprint/HeatSinkBlueprint.yaml";
    private static LinkedHashMap<String, HeatSinkBlueprint> cache = (null);
