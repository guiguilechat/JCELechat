    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/AsteroidBloodRaidersFrigate.yaml";
    ...
    public static LinkedHashMap<String, AsteroidBloodRaidersFrigate> load() {
        if ((cache==null)) {
            try {
