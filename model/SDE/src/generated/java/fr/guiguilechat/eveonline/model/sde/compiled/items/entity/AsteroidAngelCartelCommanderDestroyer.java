    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/AsteroidAngelCartelCommanderDestroyer.yaml";
    ...
    public static LinkedHashMap<String, AsteroidAngelCartelCommanderDestroyer> load() {
        if ((cache==null)) {
            try {
