    ...
    extends Ship
{
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double SpecialQuafeHoldCapacity;
    /**
     * tbd
     * 
     */
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double ShipBonusOreIndustrial1;
    /**
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double ShipBonusOreIndustrial2;
    /**
    ...
    public final static String RESOURCE_PATH = "SDE/ship/Industrial.yaml";
