    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureResourceRigMIceReprocessing.yaml";
    ...
    public static LinkedHashMap<String, StructureResourceRigMIceReprocessing> load() {
        if ((cache==null)) {
            try {
