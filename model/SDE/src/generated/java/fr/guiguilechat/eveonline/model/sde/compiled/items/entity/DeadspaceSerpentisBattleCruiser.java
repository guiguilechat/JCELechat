    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/DeadspaceSerpentisBattleCruiser.yaml";
    ...
    public static LinkedHashMap<String, DeadspaceSerpentisBattleCruiser> load() {
        if ((cache==null)) {
            try {
