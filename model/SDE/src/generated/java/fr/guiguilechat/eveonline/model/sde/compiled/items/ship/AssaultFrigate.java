    ...
    extends Ship
{
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double EliteBonusAssaultShips1;
    /**
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double EliteBonusBombers;
    /**
     * 
     * 
     */
    ...
    @Stackable(true)
    @DefaultValue(10.0D)
    public double EliteBonusEscorts;
    /**
     * 
     * 
     */
    ...
    public final static String RESOURCE_PATH = "SDE/ship/AssaultFrigate.yaml";
