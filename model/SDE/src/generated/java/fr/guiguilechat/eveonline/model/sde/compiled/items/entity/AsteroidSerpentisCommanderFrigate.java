    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/AsteroidSerpentisCommanderFrigate.yaml";
    ...
    public static LinkedHashMap<String, AsteroidSerpentisCommanderFrigate> load() {
        if ((cache==null)) {
            try {
