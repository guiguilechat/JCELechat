    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureEngineeringRigLCapitalShipEfficiency.yaml";
    private static LinkedHashMap<String, StructureEngineeringRigLCapitalShipEfficiency> cache = (null);
    ...
    public static LinkedHashMap<String, StructureEngineeringRigLCapitalShipEfficiency> load() {
        if ((cache==null)) {
            try {
