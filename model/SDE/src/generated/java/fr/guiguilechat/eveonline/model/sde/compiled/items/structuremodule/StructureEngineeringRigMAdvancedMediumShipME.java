    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureEngineeringRigMAdvancedMediumShipME.yaml";
    ...
    public static LinkedHashMap<String, StructureEngineeringRigMAdvancedMediumShipME> load() {
        if ((cache==null)) {
            try {
