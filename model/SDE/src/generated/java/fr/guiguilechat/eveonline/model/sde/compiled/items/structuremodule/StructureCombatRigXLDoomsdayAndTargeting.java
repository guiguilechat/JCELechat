    ...
    extends StructureModule
{
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double StructureRigMaxTargetBonus;
    /**
     * 
     * 
     */
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double StructureRigDoomsdayTargetAmountBonus;
    /**
     * 
     * 
     */
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureCombatRigXLDoomsdayAndTargeting.yaml";
