    ...
    extends StructureModule
{
    ...
    @Stackable(false)
    @DefaultValue(0.0D)
    public double StructureRigPDRangeBonus;
    /**
     * 
     * 
     */
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double StructureRigPDCapUseBonus;
    /**
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureCombatRigLPointDefenseBatteryApplicationAndProjection.yaml";
    private static LinkedHashMap<String, StructureCombatRigLPointDefenseBatteryApplicationAndProjection> cache = (null);
    ...
    public Class<?> getGroup() {
        return StructureCombatRigLPointDefenseBatteryApplicationAndProjection.class;
    }
