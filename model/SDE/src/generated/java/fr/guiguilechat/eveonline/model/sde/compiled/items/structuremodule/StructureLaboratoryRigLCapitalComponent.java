    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureLaboratoryRigLCapitalComponent.yaml";
    ...
    public static LinkedHashMap<String, StructureLaboratoryRigLCapitalComponent> load() {
        if ((cache==null)) {
            try {
