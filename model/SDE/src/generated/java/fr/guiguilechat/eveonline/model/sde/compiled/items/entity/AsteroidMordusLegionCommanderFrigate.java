    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/AsteroidMordusLegionCommanderFrigate.yaml";
    ...
    public static LinkedHashMap<String, AsteroidMordusLegionCommanderFrigate> load() {
        if ((cache==null)) {
            try {
