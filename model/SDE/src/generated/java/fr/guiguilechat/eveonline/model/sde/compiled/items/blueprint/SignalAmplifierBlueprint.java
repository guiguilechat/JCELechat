    ...
    extends Blueprint
{
    ...
    public final static String RESOURCE_PATH = "SDE/blueprint/SignalAmplifierBlueprint.yaml";
    private static LinkedHashMap<String, SignalAmplifierBlueprint> cache = (null);
    ...
    public static LinkedHashMap<String, SignalAmplifierBlueprint> load() {
        if ((cache==null)) {
            try {
