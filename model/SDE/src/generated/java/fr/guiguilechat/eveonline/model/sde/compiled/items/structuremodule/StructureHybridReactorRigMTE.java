    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureHybridReactorRigMTE.yaml";
    private static LinkedHashMap<String, StructureHybridReactorRigMTE> cache = (null);
    ...
    public Class<?> getGroup() {
        return StructureHybridReactorRigMTE.class;
    }

    public static LinkedHashMap<String, StructureHybridReactorRigMTE> load() {
        if ((cache==null)) {
            try {
