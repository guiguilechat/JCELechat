    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureBiochemicalReactorRigMTE.yaml";
    private static LinkedHashMap<String, StructureBiochemicalReactorRigMTE> cache = (null);
    ...
    public Class<?> getGroup() {
        return StructureBiochemicalReactorRigMTE.class;
    }

    public static LinkedHashMap<String, StructureBiochemicalReactorRigMTE> load() {
        if ((cache==null)) {
            try {
