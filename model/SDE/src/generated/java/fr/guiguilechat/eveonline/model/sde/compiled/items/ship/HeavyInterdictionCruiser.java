    ...
    extends Ship
{
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double EliteBonusHeavyInterdictors1;
    /**
     * 
     * 
     */
    ...
    @Stackable(true)
    @DefaultValue(0.0D)
    public double EliteBonusHeavyInterdictors2;
    /**
     * 
     * 
     */
    ...
    public final static String RESOURCE_PATH = "SDE/ship/HeavyInterdictionCruiser.yaml";
