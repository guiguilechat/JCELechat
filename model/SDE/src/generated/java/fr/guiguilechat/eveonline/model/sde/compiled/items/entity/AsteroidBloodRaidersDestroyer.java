    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/AsteroidBloodRaidersDestroyer.yaml";
    ...
    public static LinkedHashMap<String, AsteroidBloodRaidersDestroyer> load() {
        if ((cache==null)) {
            try {
