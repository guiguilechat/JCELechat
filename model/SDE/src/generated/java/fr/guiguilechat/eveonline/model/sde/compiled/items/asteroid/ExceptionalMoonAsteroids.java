    ...
    extends Asteroid
{
    ...
    public final static String RESOURCE_PATH = "SDE/asteroid/ExceptionalMoonAsteroids.yaml";
    private static LinkedHashMap<String, ExceptionalMoonAsteroids> cache = (null);
    ...
    public static LinkedHashMap<String, ExceptionalMoonAsteroids> load() {
        if ((cache==null)) {
            try {
