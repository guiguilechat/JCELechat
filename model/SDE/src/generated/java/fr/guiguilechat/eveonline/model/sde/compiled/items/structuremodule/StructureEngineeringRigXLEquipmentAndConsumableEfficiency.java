    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureEngineeringRigXLEquipmentAndConsumableEfficiency.yaml";
    ...
    public static LinkedHashMap<String, StructureEngineeringRigXLEquipmentAndConsumableEfficiency> load() {
        if ((cache==null)) {
            try {
