    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureEngineeringRigMBasicLargeShipTE.yaml";
    private static LinkedHashMap<String, StructureEngineeringRigMBasicLargeShipTE> cache = (null);
    ...
    public Class<?> getGroup() {
        return StructureEngineeringRigMBasicLargeShipTE.class;
    }

    public static LinkedHashMap<String, StructureEngineeringRigMBasicLargeShipTE> load() {
        if ((cache==null)) {
            try {
