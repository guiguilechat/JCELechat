    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureEngineeringRigMTEResearchAccelerator.yaml";
    private static LinkedHashMap<String, StructureEngineeringRigMTEResearchAccelerator> cache = (null);
    ...
    public Class<?> getGroup() {
        return StructureEngineeringRigMTEResearchAccelerator.class;
    }

    public static LinkedHashMap<String, StructureEngineeringRigMTEResearchAccelerator> load() {
        if ((cache==null)) {
            try {
