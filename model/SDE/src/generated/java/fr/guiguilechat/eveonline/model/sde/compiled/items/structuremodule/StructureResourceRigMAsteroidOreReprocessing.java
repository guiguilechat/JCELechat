    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureResourceRigMAsteroidOreReprocessing.yaml";
    ...
    public static LinkedHashMap<String, StructureResourceRigMAsteroidOreReprocessing> load() {
        if ((cache==null)) {
            try {
