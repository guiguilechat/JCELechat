    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/DeadspaceBloodRaidersBattleship.yaml";
    ...
    public static LinkedHashMap<String, DeadspaceBloodRaidersBattleship> load() {
        if ((cache==null)) {
            try {
