    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/DeadspaceSanshaSNationBattleship.yaml";
    ...
    public static LinkedHashMap<String, DeadspaceSanshaSNationBattleship> load() {
        if ((cache==null)) {
            try {
