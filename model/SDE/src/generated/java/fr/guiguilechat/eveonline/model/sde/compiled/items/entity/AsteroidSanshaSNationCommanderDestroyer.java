    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/AsteroidSanshaSNationCommanderDestroyer.yaml";
    ...
    public static LinkedHashMap<String, AsteroidSanshaSNationCommanderDestroyer> load() {
        if ((cache==null)) {
            try {
