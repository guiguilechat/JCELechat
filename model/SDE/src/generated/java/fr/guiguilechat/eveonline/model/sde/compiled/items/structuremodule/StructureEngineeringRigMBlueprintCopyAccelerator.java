    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureEngineeringRigMBlueprintCopyAccelerator.yaml";
    ...
    public static LinkedHashMap<String, StructureEngineeringRigMBlueprintCopyAccelerator> load() {
        if ((cache==null)) {
            try {
