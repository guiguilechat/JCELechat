...
public class StructureEngineeringRigLEquipmentEfficiency
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureEngineeringRigLEquipmentEfficiency.yaml";
    private static LinkedHashMap<String, StructureEngineeringRigLEquipmentEfficiency> cache = (null);
    ...
    public Class<?> getGroup() {
        return StructureEngineeringRigLEquipmentEfficiency.class;
    }

    public static LinkedHashMap<String, StructureEngineeringRigLEquipmentEfficiency> load() {
        if ((cache==null)) {
            try {
