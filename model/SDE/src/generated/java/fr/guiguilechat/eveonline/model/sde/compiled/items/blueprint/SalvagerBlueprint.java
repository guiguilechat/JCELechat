...
public class SalvagerBlueprint
    extends Blueprint
{
    ...
    public final static String RESOURCE_PATH = "SDE/blueprint/SalvagerBlueprint.yaml";
    private static LinkedHashMap<String, SalvagerBlueprint> cache = (null);
