    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/AsteroidMordusLegionCommanderCruiser.yaml";
    ...
    public static LinkedHashMap<String, AsteroidMordusLegionCommanderCruiser> load() {
        if ((cache==null)) {
            try {
