    ...
    extends Blueprint
{
    ...
    public final static String RESOURCE_PATH = "SDE/blueprint/MiningLaserUpgradeBlueprint.yaml";
    private static LinkedHashMap<String, MiningLaserUpgradeBlueprint> cache = (null);
    ...
    public static LinkedHashMap<String, MiningLaserUpgradeBlueprint> load() {
        if ((cache==null)) {
            try {
