    ...
    extends Entity
{
    ...
    public final static String RESOURCE_PATH = "SDE/entity/MissionGallenteFederationDestroyer.yaml";
    ...
    public static LinkedHashMap<String, MissionGallenteFederationDestroyer> load() {
        if ((cache==null)) {
            try {
