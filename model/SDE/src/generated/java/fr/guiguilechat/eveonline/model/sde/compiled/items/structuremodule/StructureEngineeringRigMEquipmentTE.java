    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureEngineeringRigMEquipmentTE.yaml";
    private static LinkedHashMap<String, StructureEngineeringRigMEquipmentTE> cache = (null);
    ...
    public Class<?> getGroup() {
        return StructureEngineeringRigMEquipmentTE.class;
    }

    public static LinkedHashMap<String, StructureEngineeringRigMEquipmentTE> load() {
        if ((cache==null)) {
            try {
