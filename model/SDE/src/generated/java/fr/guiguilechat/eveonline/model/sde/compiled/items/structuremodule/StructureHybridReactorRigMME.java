    ...
    extends StructureModule
{
    ...
    public final static String RESOURCE_PATH = "SDE/structuremodule/StructureHybridReactorRigMME.yaml";
    ...
    public static LinkedHashMap<String, StructureHybridReactorRigMME> load() {
        if ((cache==null)) {
            try {
