    ...
    extends RequestHandler
{
    ...
    public default R_get_alliances_names_ok[] get_alliances_names(int[] alliance_ids) {
    ...
    public default R_post_characters_character_id_assets_names_ok[] post_characters_character_id_assets_names(int character_id, int[] item_ids) {
        ...
        String fetched=connectPost(url, content);
        return convert(fetched, is.ccp.tech.esi.responses.R_post_characters_character_id_assets_names_ok[].class);
    }

    public default R_post_characters_character_id_assets_locations_ok[] post_characters_character_id_assets_locations(int character_id, int[] item_ids) {
    ...
    public default R_post_corporations_corporation_id_assets_names_ok[] post_corporations_corporation_id_assets_names(int corporation_id, int[] item_ids) {
    ...
    public default R_post_corporations_corporation_id_assets_locations_ok[] post_corporations_corporation_id_assets_locations(int corporation_id, int[] item_ids) {
    ...
    public default R_post_characters_affiliation_ok[] post_characters_affiliation(int[] characters) {
    ...
    public default R_get_characters_names_ok[] get_characters_names(int[] character_ids) {
    ...
    public default R_get_characters_character_id_roles_ok get_characters_character_id_roles(int character_id) {
    ...
    public default R_get_corporations_names_ok[] get_corporations_names(int[] corporation_ids) {
    ...
    public default R_get_corporations_corporation_id_starbases_starbase_id_ok get_corporations_corporation_id_starbases_starbase_id(int corporation_id, int starbase_id, int system_id) {
    ...
    public default R_get_characters_character_id_online_ok get_characters_character_id_online(int character_id) {
    ...
    public default R_get_markets_region_id_orders_ok[] get_markets_region_id_orders(String order_type, int region_id) {
    ...
    public default R_get_markets_region_id_history_ok[] get_markets_region_id_history(int region_id, int type_id) {
    ...
    public default R_get_characters_character_id_search_ok get_characters_character_id_search(String[] categories, int character_id, String search) {
    ...
    public default R_post_universe_names_ok[] post_universe_names(int[] ids) {
