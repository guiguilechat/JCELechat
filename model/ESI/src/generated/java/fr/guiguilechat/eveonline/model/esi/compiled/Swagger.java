...
import fr.guiguilechat.eveonline.model.esi.compiled.responses.*;
...
public interface Swagger {
	...
	public default R_get_corporations_corporation_id_industry_jobs[] get_corporations_corporation_id_industry_jobs(int corporation_id, Boolean include_completed, Integer page, Map<String, List<String>> headerHandler) {
		System.err.println("calling corporation industry jobs ");
		String url = "https://esi.tech.ccp.is/latest/corporations/{corporation_id}/industry/jobs/"
				.replace("{corporation_id}", "" + corporation_id) + "?"
				+ (include_completed == null ? "" : "&include_completed=" + flatten(include_completed))
				+ (page == null ? "" : "&page=" + flatten(page));
		String fetched=connectGet(url,true, headerHandler);
