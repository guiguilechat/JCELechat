    ...
    extends RequestHandler
{
    ...
    public default double post_characters_character_id_cspa(long character_id, long[] characters) {
    ...
    public default long[] post_characters_character_id_contacts(long character_id, long[] contact_ids, double standing) {
    ...
    public default R_post_characters_character_id_fittings_created post_characters_character_id_fittings(long character_id) {
        String url = ("https://esi.tech.ccp.is/latest/characters/{character_id}/fittings/".replace("{character_id}", ""+character_id));
    ...
    public default void post_fleets_fleet_id_members(long fleet_id, long character_id, String role, long wing_id, long squad_id) {
        String url = ("https://esi.tech.ccp.is/latest/fleets/{fleet_id}/members/".replace("{fleet_id}", ""+fleet_id));
        Map<String, String> content = new HashMap<>();
    ...
    public default long post_characters_character_id_mail(long character_id, is.ccp.tech.esi.structures.recipients[] recipients, String subject, String body, long approved_cost) {
        String url = ("https://esi.tech.ccp.is/latest/characters/{character_id}/mail/".replace("{character_id}", ""+character_id));
        Map<String, String> content = new HashMap<>();
    ...
    public default long post_characters_character_id_mail_labels(long character_id) {
        String url = ("https://esi.tech.ccp.is/latest/characters/{character_id}/mail/labels/".replace("{character_id}", ""+character_id));
        String fetched = connectPost(url, Collections.emptyMap(), true);
        connectPost(url, Collections.emptyMap(), true);
        return convert((fetched), (long.class));
    ...
    public default void post_ui_openwindow_marketdetails(long type_id) {
        String url = ("https://esi.tech.ccp.is/latest/ui/openwindow/marketdetails/"+"?type_id="+flatten(type_id));
        connectPost(url, Collections.emptyMap(), true);
    }

    public default void post_ui_openwindow_contract(long contract_id) {
        String url = ("https://esi.tech.ccp.is/latest/ui/openwindow/contract/"+"?contract_id="+flatten(contract_id));
        connectPost(url, Collections.emptyMap(), true);
    }

    public default void post_ui_openwindow_information(long target_id) {
    ...
    public default void post_ui_openwindow_newmail(String subject, String body, long[] recipients, long to_mailing_list_id, long to_corp_or_alliance_id) {
