	...
	public String locationName(long locationid) {
		...
		if (ret == null) {
			if (locationid < Integer.MAX_VALUE) {
				...
				case 1://region
					ret = parent.raw.get_universe_regions_region_id((int) locationid, null).name;
					break;
				case 2://constellation
					ret = parent.raw.get_universe_constellations_constellation_id((int) locationid, null).name;
					break;
				case 30:
				case 31:
				case 32:// system
					ret = parent.raw.get_universe_systems_system_id((int) locationid, null).name;
					break;
				case 60:
				case 61:
				case 62:
