...
public class MissionPane extends GridPane implements PaneWithRepresentation {
	...
	public MissionPane(String name, MissionStats options) {
		...
		isk_cstt = TextFieldRepresentation.positivIntField(options::getIsk_cstt, options::setIsk_cstt);
		...
		lp = TextFieldRepresentation.positivIntField(options::getLp, options::setLp);
		...
		align_time_s = TextFieldRepresentation.positivIntField(options::getAlign_time_s, options::setAlign_time_s);
		...
		timetokill_s = TextFieldRepresentation.positivIntField(options::getTimetokill_s, options::setTimetokill_s);
