...
public class ConvertNameId {
	...
	private static final String in=
			"10MN Monopropellant Enduring Afterburner\n"
					...
					+ "Auxiliary Parts\n"
					+ "Barbican' 800mm Steel Plates Blueprint\n"
					...
					+ "Full Duplex' Ballistic Control System Blueprint\n"
					...
					+ "Graviton Physics\n"
					+ "Hauberk' Large Armor Repairer I Blueprint\n"
					+ "Heat Depressor\n"
					+ "High Energy Physics\n"
					...
					+ "Investor' Tracking Disruptor I Blueprint\n"
					...
					+ "Large Degenerative Concussion Bomb I Blueprint\n"
					+ "Large Rudimentary Concussion Bomb I\n"
					+ "Mainframe Bit\n"
					+ "Malkuth' Heavy Missile Launcher I\n"
					+ "Mechanic Parts\n"
					+ "Mechanical Engineering\n"
					+ "Meditation' Medium Armor Repairer I Blueprint\n"
					...
					+ "Nuclear Physics\n"
					+ "Nugget' Kinetic Shield Hardener Blueprint\n"
					...
					+ "Plasma Physics\n"
					+ "Plunderer' Gravimetric ECM Blueprint\n"
					...
					+ "Synthetic Hull Conversion Nanofiber Structure Blueprint\n"
